...
<link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url();?>assets/img/favicon.ico"/>
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>assets/css/style.css?v=3.4.4.8" />
     <!-- <link rel="stylesheet" href="<?php echo base_url();?>assets/css/seller.css" /> -->
    <link rel="stylesheet" href="<?php echo base_url();?>assets/css/responsive.css?v=4.3.4.9" />
                ...
                <div class="navbar-brand mobapp-navbar-inner">
                    ...
                    <div class="dropdown project-dropdown dropdown-trigger is-spaced">
                        <div class="h-avatar is-small">
                            <span class="avatar is-fake <?php echo @$store_color[$this->session->userdata('storefront')->admin_id];?>">
                              <span title="<?php
                         ...
                         <div class="dropdown-menu" role="menu">
                            <div class="dropdown-content">
                                ...
                                <div class="dropdown-block" onclick="set_storefront('<?php echo $branch->admin_id;?>');">
                                    <div class="h-avatar is-small">
                                        <span class="avatar is-fake <?php echo @$store_color[$branch->admin_id];?>">
            ...
            <div class="webapp-navbar-inner">
                ...
                <div class="right">
                    ...
                    <div class="dropdown profile-dropdown dropdown-trigger is-spaced is-right">
                        ...
                        <img class="light-image" src="<?php echo $this->session->userdata('storefront')->admin_profile_pic ;?>" alt="" />
