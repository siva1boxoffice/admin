      ...
      <div class="page-title-box">
         <div class="container-fluid">
            <div class="page-title dflex-between-center">
               <h3 class="mb-1">SEO Country List</h3>
               <div class="float-sm-right mt-3 mt-sm-0 add_team_s">
                  <a href="<?php echo base_url();?>settings/seo_country_list/add"  class="btn btn-success mb-2">Add</a>
                </div>
            </div>
         </div>
      </div>
                                    ...
                                    <li class="sort_list">
                                       <div class="btn-group">
                                          <div class="dropdown">
                                             ...
                                             data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            Top Country <i class="mdi mdi-chevron-down"></i>
                                             </button>
                                             <div class="dropdown-menu dropdown-menu-custom" aria-labelledby="dropdownMenuButton">
...
<script>
   ...
   var Dtable = $('#tournament-list').DataTable({
         ...
         "bSort": false,
         "ajax": {
            url: base_url + 'settings/get_seo_country_list',
            data: function (d) {
               ...
               var status= '';
                     ...
                     var top_country_status= '';
                     $('.venue_status').each(function(i,e) {
                        if ($(e).is(':checked')) {
                                 var comma = top_country_status.length===0?'':',';
                                 top_country_status += (comma+e.value);
                        }
                     });

                d.country = countryIds;
                d.status = status;
                d.top_country = top_country_status;
