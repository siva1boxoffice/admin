      ...
      <div class="page-title-box">
         <div class="container-fluid">
            <div class="page-title dflex-between-center">
               <h3 class="mb-1">SEO City List</h3>
               <div class="float-sm-right mt-3 mt-sm-0 add_team_s">
                  <a href="<?php echo base_url();?>settings/seo_city_list/add"  class="btn btn-success mb-2">Add</a>
                </div>
            </div>
         </div>
      </div>
                                    ...
                                    <li class="sort_list">
                                       <div class="btn-group">
                                          <div class="dropdown">
                                             ...
                                             data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            Top City <i class="mdi mdi-chevron-down"></i>
                                             </button>
                                             <div class="dropdown-menu dropdown-menu-custom" aria-labelledby="dropdownMenuButton">
...
<script>
   ...
   var Dtable = $('#tournament-list').DataTable({
         ...
         "bSort": false,
         "ajax": {
            url: base_url + 'settings/get_seo_city_list',
            data: function (d) {
               ...
               $(".check_box input:checked").each(function() {
                  ...
                  var ID = $(this).attr('id');
                  var newID = ID.replace("tournament_id", "");     
               ...
               var status= '';
                     ...
                     $('.venue_status').each(function(i,e) {
                        if ($(e).is(':checked')) {
                                 var comma = top_city_status.length===0?'':',';
                                 top_city_status += (comma+e.value);
                        }
                     });

                d.country = countryIds;
                d.status = status;
                d.top_city = top_city_status;
      ...
      $('.top_status_search_filter').text("Top City");
    ...
    $('.status_search').on('click', function (e) {
      ...
      $(".check_box").change(function() { 
         ...
         function applyFilters() {
            ...
            sessionStorage.setItem('seo_city', JSON.stringify(filters));
          Dtable.draw();        
...
var storedFilters = sessionStorage.getItem('seo_city');
   
  if (storedFilters) {
      var filters = JSON.parse(storedFilters);     
      var country_name =filters.country_name;
      var status =filters.status;
      var  top_city=filters.top_city;
     // return false;
$(".check_box_stadium_status input[type='checkbox'], .check_box_status input[type='checkbox']").each(function() {
  ...
  if ($(this).closest('.check_box_stadium_status').length) {
    ...
    if (status.includes(ID)) {
      ...
      if (top_city && top_city.length > 0) {
         $('.top_status_search_filter').addClass("filter_active");
         $('.top_status_search_filter').text(top_city.length + " Selected");
      }
  ...
  var filters = JSON.parse(sessionStorage.getItem('seo_city'));
