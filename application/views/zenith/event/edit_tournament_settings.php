<?php $this->load->view('common/header');?>
      ...
      <div class="page-content is-relative business-dashboard course-dashboard">
                     ...
                     <div class="page-content-inner">
                         <form id="branch-form" method="post" class="validate_form_v1 login-wrapper" action="<?php echo base_url();?>settings/tournaments/save_tournaments_settings">
                            <?php
                            $tId = json_decode(base64_decode($this->uri->segment(4)));
                            ?>
                            <input type="hidden" name="tid" value="<?php echo $tId;?>">
                         <div class="dashboard-title is-main">
                                <div class="left">
                                    <h2 class="dark-inverted">Event Settings</h2>
                                </div>
                            </div>
                            ...
                            <div class="form-outer">
                                <div class="form-header stuck-header">
                                    <div class="form-header-inner">
                                        <div class="left">
                                            <h3>Create Tournaments Settings</h3>
                                        </div>
                                        <div class="right">
                                            <div class="buttons">
                                        ...
                                        <div class="columns is-multiline">
                                             ...
                                             <div class="column is-12">
                                                <div class="field">
                                                    ...
                                                    <option <?php if (in_array($seller->admin_id, explode(',',$tournament_settings->sellers)))
                                             ...
                                             <div class="column is-12">
                                                <div class="field">
                                                   ...
                                                   <!--  <option value="">-Choose Partners-</option> -->
                                                    ...
                                                    <option <?php if (in_array($partner->admin_id, explode(',',$tournament_settings->partners)))
                                              ...
                                              <div class="column is-12">
                                                <div class="field">
                                                   ...
                                                   <!--  <option value="">-Choose Afiliate-</option> -->
                                                    ...
                                                    <option <?php if (in_array($afiliate->admin_id, explode(',',$tournament_settings->afiliates)))
                                            ...
                                            <div class="column is-12">
                                                <div class="field">
                                                   ...
                                                   <!--  <option value="">-Choose Storefronts-</option> -->
                                                    ...
                                                    <option <?php if (in_array($storefront->admin_id, explode(',',$tournament_settings->storefronts)))
  { ?> selected <?php } ?>  value="<?php echo $storefront->admin_id;?>"><?php echo $storefront->admin_name;?> <?php echo $storefront->admin_last_name;?> (<?php echo $storefront->company_name;?>)</option>
                                             ...
                                             <div class="column is-12">
                                                <div class="field">
                                                    <label>Tournament Settings Status *</label>
                                                     <div class="control has-icon">
                                                                <div class="switch-block no-padding-all">
                                                                    <label class="form-switch is-primary">
<input type="checkbox" class="is-switch" name="status" value="1" 
<?php if($tournament_settings->status == '1'){?> checked <?php } ?>>
                                                                        <i></i>
                                                                    </label>
                                                                    <div class="text">
                                                                        <span>Enable / disable Tournament Settings Status</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                </div>
