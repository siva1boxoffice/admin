   ...
   <div class="page-content">
      ...
      <div class="page-title-box tick_details">
         <div class="container-fluid">
            <div class="row">
               <div class="col-sm-8">
                  <h5 class="card-title">SEO Country </h5>
               </div>
               <div class="col-sm-4">
                     ...
                     <div class="col-lg-12">
                        ...
                        <div class="tab-content">
                           ...
                           <form id="match-form" method="post"
                                          ...
                                          action="<?php echo base_url(); ?>settings/seo_country_list/save"
                              ...
                              <div class="row">                              
                                 <div class="col-12">
                                    <div class="card">
                                       <div class="">
                                          <h5 class="card-title">SEO Country</h5>
                                          <p>Fill the following SEO Country information</p>
                                       </div>
                                          ...
                                          <div class="col-lg-6" style="display:none">
                                                ...
                                                <div class="col-lg-6">
                                                   <div class="form-group">
                                                      ...
                                                      <select class="custom-select change_country" id="country" name="top_country" onchange="get_state_city(this.value);" required>
                                                ...
                                                <div class="col-lg-6">
                                                   <div class="form-group">
                                                      <label for="example-select">Country Image (40x40) <span
                                                      ...
                                                      <div class="prev_back_img">
                                                         <label class="custom-upload mb-0"><input type="hidden"
                                                            ...
                                                            File</label>
                                                         <p>Preview Country Image </p>
                                                         <a id="blog_img_file_link" target="_blank"
                                                            href="javascript:void(0);" onclick="return popitup('<?php if (isset($tournaments->country_image)) { echo UPLOAD_PATH . 'uploads/seo_country/' . $tournaments->country_image; } ?>')" class="view_bg">
                                                            <img width="30" height="30" src="<?php if (isset($tournaments->country_image)) {
                                                               echo UPLOAD_PATH . 'uploads/seo_country/' . $tournaments->country_image;
                                                            } else {
                                                ...
                                                <div class="col-lg-6">
                                                   <div class="form-group">
                                                      <label for="example-select">Country Icon (40x40) <span
                                                            class="text-danger">*</label>
                                                      <div class="prev_back_img">
                                                         <label class="custom-upload mb-0"><input type="hidden"
                                                               name="exs_file_icon" value="<?php if (isset($tournaments->country_icon)) {
                                                                  echo $tournaments->country_icon;
                                                               } ?>"><input type="file" class="form-control-file input"
                                                               name="country_icon" id="country_icon" value=""
                                                               onchange="loadFiles_icon(event,'blog_img_file_icon')"  <?php if($tournaments->c_id==""){?> required <?php } ?> accept="image/*"> Upload JPEG
                                                            File</label>
                                                         <p>Preview Country Icon </p>
                                                         <a id="blog_img_file_icon_link" target="_blank"
                                                            href="javascript:void(0);" onclick="return popitup('<?php if (isset($tournaments->country_icon)) { echo UPLOAD_PATH . 'uploads/seo_country_icon/' . $tournaments->country_icon; } ?>')" class="view_bg">
                                                            <img width="30" height="30" src="<?php if (isset($tournaments->country_icon)) {
                                                               echo UPLOAD_PATH . 'uploads/seo_country_icon/' . $tournaments->country_icon;
                                                            } else {
                                                               echo UPLOAD_PATH . 'uploads/general_settings/no-image.png';
                                       ...
                                       <div class="col-lg-12">
                                          <div class="data_edit">
                                             <table style="width: 100%;"> 
                                                ...
                                                <tr>
                                                   <td><label for="sellers" class="mb-0">Top Country</label></td>
                                                   <td>
                                                      <div class="form-group mb-1 cust-switch">
                                                         No / Yes
                                                         <div class="custom-control custom-switch">
                                                            <input type="checkbox" class="custom-control-input" id="customSwitch20" name="top_country_status" value="1" <?php if ($tournaments->top_country_status==1 ) { echo 'checked';  }?> ><label class="custom-control-label" for="customSwitch20"></label>
                                                         </div>
                                                      </div>
                                                   </td>
                                                </tr>
                                          ...
                                          <div class="col-lg-12">
                                             <div class="tick_details border-top">
                                                <div class="row">
                                                   ...
                                                   <div class="col-sm-4">
                                                      <div class="float-sm-right mt-2 mt-sm-0 ml-sm-1 mx-sm-2">
                                                         <a href="<?php echo base_url(); ?>settings/seo_country_list/"
                                    ...
                                    <div class="card">
                                       ...
                                       <div class="">
                                          <form id="seo_tab" method="post"
                                             ...
                                             action="<?php echo base_url(); ?>settings/seo_country_list/save/1">
                                             <input type="hidden" name="seocountryId" value="<?php if (isset($tournaments->c_id)) {
                                                echo $tournaments->c_id;
                                             } ?>">
                                             <input type="hidden" name="seo_country_name" value="<?php if (isset($tournaments->country_name)) {
                                                echo $tournaments->country_name;
                                             } ?>">
                                                ...
                                                <div class="col-lg-6" >
                                                   <div class="form-group">
                                                      ...
                                                      <input disabled type="text" id="" name="" class="form-control"
                                                         ...
                                                         value="<?php
                                                         echo isset($tournaments->country_name) ? $tournaments->country_name : ''; ?>">
                                       ...
                                       <div class="">
                                          <form id="page_content_tab" method="post"
                                             ...
                                             <?php //if (isset($tournaments->pcontent)) {     echo $tournaments->pcontent;    } ?>
                                                <div class="col-lg-12">
                                                   <div class="form-group">
                                                      <label for="example-textarea">Country Content 1</label>
                                                      <textarea id="editor-4" name="country_content_1"
                                                         placeholder="Enter Country Content 1"><?php echo isset($tournaments->country_content_1) ? $tournaments->country_content_1 : ''; ?></textarea>
                                                   </div>
                                                </div>

                                                <div class="col-lg-12">
                                                   <div class="form-group">
                                                      <label for="example-textarea">Country Content 2</label>
                                                      <textarea id="editor-5" name="country_content_2"   placeholder="Enter Country Content 2"><?php echo isset($tournaments->country_content_2) ? $tournaments->country_content_2 : ''; ?></textarea>
                                                   </div>
                                                </div>
...
new Choices(document.getElementById("search_keywords"), { delimiter: ",", editItems: !0, removeItemButton: !0 });
            ...
            <?php // if (empty($tournaments->c_id)) { ?>
               ...
               <?php //} ?>
                     ...
                     $(".change_country").change(function() {
                        ...
                        if (val && <?php echo empty($tournaments->c_id) ? 'true' : 'false'; ?>) {
                           slug = slugfly(val);
                           $("#url_key").val(slug );
 ...
 <?php } ?>
      ...
      <?php if (empty($tournaments->c_id)) { ?>
         if (href != "home") {
                     swal('Attention!', ' Please Fill The Country Details', 'error');
                     return false;
                  }
     <?php } else {
         ?>
