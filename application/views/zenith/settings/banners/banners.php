   ...
   <div class="page-content">
      ...
      <div class="page-title-box">
         <div class="container-fluid">
            ...
            <div class="page-title dflex-between-center">
               <h3 class="mb-1">Banner  Lists</h3>
               <div class="float-sm-right mt-3 mt-sm-0 add_team_s">
                  <a href="<?php echo base_url(); ?>settings/banners/add"  class="btn btn-success mb-2">Add Banner </a>
               </div>
             </div>
         </div>
      </div>
                                       ...
                                       <div class="btn-group">
                                          <div class="dropdown">
                                             <button class="btn btn-light dropdown-toggle ticket_search_filter" type="button"
                                                ...
                                                aria-expanded="false">
                                                Banner Title <i class="mdi mdi-chevron-down"></i>
                                             </button>
...
<script>
   ...
   var Dtable = $('#banner-list').DataTable({
         ...
         "bSort": false,
         "ajax": {
            url: base_url + 'settings/get_banner_list',
            data: function (d) {
				var page_title = $("#ticket_type").val();
				var statuss= '';
	  ...
	  $("body").on("click",".status_reset",function(){
	   ...
	   $("body").on("click",".split_reset",function(){
         ...
         var checkedIds = [];
            ...
            const banner_type=document.getElementById('ticket_type').value;         
            ...
            sessionStorage.setItem('banner_type', JSON.stringify(filters));
          Dtable.draw();        
...
var storedFilters = sessionStorage.getItem('banner_type');
  if (storedFilters) {
      var filters = JSON.parse(storedFilters);     
     
      var banner_type = filters.banner_type;
...
$(".check_box input[type='checkbox']").each(function() {
  ...
  var filters = JSON.parse(sessionStorage.getItem('banner_type'));
  ...
  if (filters["ticket_type_" + argName] && filters["ticket_type_" + argName] !== "") {
    ...
    filters = {
		banner_type: filters.banner_type,
