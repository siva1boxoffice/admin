         ...
         <div class="container-fluid">
            ...
            <div class="page-title dflex-between-center">
               ...
               <div class="float-sm-right mt-3 mt-sm-0 add_team_s">
                  <a href="<?php echo base_url(); ?>settings/ticket_types/add"  class="btn btn-success mb-2">Add Ticket Type</a>
               </div>
             </div>
         </div>
      </div>
         ...
         <div class="container-fluid">
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="">
                     <table style='width:100% !important' id="ticket-type-list" class="table table-hover table-nowrap mb-0 tournament">
...
<script>
   ...
   var Dtable = $('#ticket-type-list').DataTable({
         ...
         "bSort": false,
         "ajax": {
            url: base_url + 'settings/get_ticket_type_list',
            data: function (d) {
	  ...
	  $("body").on("click",".status_reset",function(){
	   ...
	   $("body").on("click",".split_reset",function(){
         ...
         var checkedIds = [];
            ...
            sessionStorage.setItem('ticket_type', JSON.stringify(filters));
          Dtable.draw();        
...
var storedFilters = sessionStorage.getItem('ticket_type');
  if (storedFilters) {
...
$(".check_box input[type='checkbox']").each(function() {
  ...
  var filters = JSON.parse(sessionStorage.getItem('ticket_type'));
