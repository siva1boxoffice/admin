...
<button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#centermodal_add" fdprocessedid="1invro">Add New Customer</button>
                  ...
                  <div class="card">
                     <div class="card-body">
                        ...
                        <div class="table-responsive">
                           <table id="customer-datatable" class="table  table-hover table-nowrap mb-0">
