               ...
               <div class="container-fluid">
                  <div class="page-title dflex-between-center mb-2">
                     ...
                     <div class="add_new_btn">
                        <a href="#" class="btn btn-primary waves-effect waves-light" data-effect="wave">
                  ...
                  <div class="card">
                     <div class="card-body">
                        ...
                        <div class="table-responsive coupon_list_tab">
                           <table id="coupon-datatable" class="table table-responsive table-hover table-nowrap mb-0">
