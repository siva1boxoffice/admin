   ...
   <div class="page-content">
      ...
      <div class="page-title-box">
         <div class="container-fluid">
            ...
            <div class="page-title dflex-between-center">
               <h3 class="mb-1">SiteFee Markup Lists</h3>
               <div class="float-sm-right mt-3 mt-sm-0 add_team_s">
                  <a href="<?php echo base_url(); ?>settings/sitefee_settings/add_sitefee_settings"  class="btn btn-success mb-2">Add SiteFee Markup</a>
               </div>
             </div>
         </div>
      </div>
         ...
         <div class="container-fluid">
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="">
                     <table style='width:100% !important' id="sitefee-list" class="table table-hover table-nowrap mb-0 tournament">
...
<script>
    ...
    var overlay = $('#overlay');
   var Dtable = $('#sitefee-list').DataTable({
         'info': false,
         'serverSide': true,
         'serverMethod': 'post',
         // 'scrollX': !0,
         ...
         "bSort": false,
         "ajax": {
            url: base_url + 'settings/get_sitefee_list',
            data: function (d) {
	  ...
	  $("body").on("click",".status_reset",function(){
	   ...
	   $("body").on("click",".split_reset",function(){
         ...
         var checkedIds = [];
            ...
            const tournament=document.getElementById('ticket_type').value;         
            ...
            sessionStorage.setItem('site_settings', JSON.stringify(filters));
          Dtable.draw();        
...
var storedFilters = sessionStorage.getItem('site_settings');
  if (storedFilters) {
      var filters = JSON.parse(storedFilters);     
     
      var tournament = filters.tournament;
...
$(".check_box input[type='checkbox']").each(function() {
  ...
  var filters = JSON.parse(sessionStorage.getItem('site_settings'));
