   ...
   <div class="page-content">
      ...
      <div class="page-title-box">
         <div class="container-fluid">
            ...
            <div class="page-title dflex-between-center">
               <h3 class="mb-1">Email Access Lists</h3>
               <!-- <div class="float-sm-right mt-3 mt-sm-0 add_team_s">
                  <a href="<?php //echo base_url(); ?>settings/ticket_types/add"  class="btn btn-success mb-2">Add Email Access</a>
               </div> -->
             </div>
         </div>
      </div>
         ...
         <div class="container-fluid">
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="">
                     <table style='width:100% !important' id="email-list" class="table table-hover table-nowrap mb-0 tournament">
...
<script>
    ...
    var overlay = $('#overlay');
   var Dtable = $('#email-list').DataTable({
         'info': false,
         'serverSide': true,
         'serverMethod': 'post',
         // 'scrollX': !0,
         ...
         "bSort": false,
         "ajax": {
            url: base_url + 'settings/get_email_list',
            data: function (d) {
	  ...
	  $("body").on("click",".status_reset",function(){
	   ...
	   $("body").on("click",".split_reset",function(){
         ...
         var checkedIds = [];
            ...
            var filters = {
               ticket_type_ticket_type: ticket_type,
               ticket_type_status: checkedIds
            // ... Add other filters
            };
            sessionStorage.setItem('email_filter', JSON.stringify(filters));
          Dtable.draw();        
...
var storedFilters = sessionStorage.getItem('email_filter');
  if (storedFilters) {
      var filters = JSON.parse(storedFilters);     
     
      var ticket_type = filters.ticket_type_ticket_type;
      var status =filters.ticket_type_status;
...
$(".check_box input[type='checkbox']").each(function() {
  ...
  var filters = JSON.parse(sessionStorage.getItem('email_filter'));

  // Check if sales_summary_seller_name has a value
  if (filters["ticket_type_" + argName] && filters["ticket_type_" + argName] !== "") {
    // Clear the remaining values while keeping the existing ticket_type_seller_name value
    filters["ticket_type_" + argName] = "";
    filters = {
      ticket_type_ticket_type: filters.ticket_type_ticket_type,
      ticket_type_status: filters.ticket_type_status,
    };
  }
