...
<?php 
   ...
   // $stadiums   = $this->General_Model->get_stadium()->result();
     $match_lists   = $this->General_Model->get_match_list();//  print_r($match_lists);
    $only = @$_GET['only'] ;
                  ...
                  <div class="row align-items-center">
                     <div class="col-sm-4 col-xl-4">
                        <div class="page-title">
                           <h3 class="mb-1 font-weight-bold">Affilate Events Links</h3>
                        </div>
                     </div>
                     <div class="col-sm-8 col-xl-8 text-sm-right mt-2 mt-sm-0">
                        <div class="float-sm-right mt-3 mt-sm-0 team_lists_bttn">
                        
                           <a href="<?php echo base_url();?>settings/match_settings/set_affiliate_settings"  class="btn btn-success mb-2 ">Add Events Links</a>
                        </div>
                     </div>
                  </div>
               </div>
                                ...
                                <input type="hidden" class="flag" name="flag" id="flag" value="<?php echo $this->uri->segment(3);?>">
                                 ...
                                 <ul>
                                     ...
                                     <li class="sort_list">
                                       <div class="btn-group">
                                          <div class="dropdown">
                                             ...
                                             <span class="text_class">Affilate</span>  <span class="selected_class"></span> <i class="mdi mdi-chevron-down"></i>
                                             </button>
                                             <div class="dropdown-menu dropdown-menu-custom" aria-labelledby="dropdownMenuButton">
                                                ...
                                                <div class="check_box">
                                                     <?php if($afiliates){
                                                        foreach ($afiliates as $key => $value) {
                                                          ?>
                                                  <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input afiliates_id" id="afiliates<?php echo $key;?>" name="afiliates[]" value="<?php echo $value->admin_id;?>">
                                                    <label class="custom-control-label" for="afiliates<?php echo $key;?>"><?php echo $value->admin_name;?> </label>
                                                  </div>
                                              <?php } }  ?>
                                                ...
                                                <div class="reset_btn">
                                                   ...
                                                   <div class="reset_ok"><button class="btn btn-info afiliates_search">Search</button></div>
                                                </div>                                               
                                    ...
                                    <li class="sort_list">
                                       <div class="btn-group">
                                          <div class="dropdown">
                                             <button class="btn btn-light dropdown-toggle match_search_filter" type="button" id="dropdownMenuButton"
                                             data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <span class="text_class">Match List</span>  <span class="selected_class"></span> <i class="mdi mdi-chevron-down"></i>
                                             </button>
                                             <div class="dropdown-menu dropdown-menu-custom" aria-labelledby="dropdownMenuButton">
                                                <div id="view_project_list_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                                <div id="view_project_list_filter" class="dataTables_filter"><label class="search-box d-inline-flex position-relative">Search:<input type="search" class="form-control form-control-sm search_box" placeholder="Search in Filters..." aria-controls="view_project_list" id='match_search_box'></label></div>
                                             </div>
                                                ...
                                                <div class="check_box">
                                                     <?php if($match_lists){
                                                        foreach ($match_lists as $key => $value) {
                                                          ?>
                                                  <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input match_id" id="match_id<?php echo $key;?>" name="match_id[]" value="<?php echo $value->m_id;?>">
                                                    <label class="custom-control-label" for="match_id<?php echo $key;?>"><?php echo $value->match_name;?></label>
                                                  </div>
                                              <?php } }  ?>
                                                ...
                                                <div class="reset_btn">
                                                   <div class="reset_txt"><button class="btn btn-info clear_all_single">Reset</button></div>
                                                   <div class="reset_ok"><button class="btn btn-info match_search">Search</button></div>
                                                </div>                                               
                                    ...
                                    <li class="sort_list">
                                       <div class="btn-group">
                                          <div class="dropdown">
                                             ...
                                             data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                             <span class="text_class">Tournament</span>  <span class="selected_class"></span> <i class="mdi mdi-chevron-down"></i>
                                             </button>
                                             <div class="dropdown-menu dropdown-menu-custom" aria-labelledby="dropdownMenuButton">
                                                <div id="view_project_list_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                           ...
                           <table style="width: 100% !important;" class="table  table-hover table-nowrap mb-0 events_new-1" id="view_project_list">
                              ...
                              <thead class="thead-light">
                                 <tr>
                                    ...
                                    <th class="before_none">AFFILIATE</th>
                                    <th class="before_none">REFERENCE</th>
                                    <th class="before_none">LANGUAGE</th>
                                    <th class="before_none">MATCH NAME</th>
                                    <th class="before_none">MATCH DATE</th>
                                    <th class="before_none">TOURNAMENT</th>
                                    <th class="before_none">LINKS STATUS</th>
                                    <th class="before_none">MATCH STATUS</th>
                                    <th class="before_none">LINK</th>
       ...
       var Dtable =  $('#view_project_list').DataTable(
{
        ...
        "ordering": false,
         ...
         //  'info': false,
          'ajax': {
             'url':'<?php echo base_url('ajax/affiliate_mathes_settings') ;?>',
              data: function (d) {
                ...
                var stadium = $(".stadium").val();
                     ...
                     var afiliates_ids= '';
                     $('.afiliates_id').each(function(i,e) {
                        if ($(e).is(':checked')) {
                                 var comma = afiliates_ids.length===0?'':',';
                                 afiliates_ids += (comma+e.value);
                        }
                     });
    ...
    complete: function() {
      ...
      // $('.match_search').on('click', function (e) {
      //    $('.match_search_filter').addClass("filter_active");
      //    Dtable.ajax.reload();
      // });
   ...
   //  });
        ...
        function copyToClipboard(val) {
            ...
            swal("Copied Successfully",val, "success");
          }
