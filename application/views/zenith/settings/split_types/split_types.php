         ...
         <div class="container-fluid">
            ...
            <div class="page-title dflex-between-center">
               ...
               <div class="float-sm-right mt-3 mt-sm-0 add_team_s">
                  <a href="<?php echo base_url(); ?>settings/split_types/add"  class="btn btn-success mb-2">Add Split Type</a>
               </div>
             </div>
         </div>
      </div>
         ...
         <div class="container-fluid">
            <div class="card">
               <div class="card-body">
                                       ...
                                       <div class="btn-group">
                                          <div class="dropdown">
                                             <button class="btn btn-light dropdown-toggle split_id_search_filter" type="button"
                                                ...
                                                aria-expanded="false">
                                                Split Type <i class="mdi mdi-chevron-down"></i>
                                             </button>
                  ...
                  <div class="">
                     <table style='width:100% !important' id="split-type-list" class="table table-hover table-nowrap mb-0 tournament">
...
<script>
    ...
    var overlay = $('#overlay');
   var Dtable = $('#split-type-list').DataTable({
         'info': false,
         'serverSide': true,
         'serverMethod': 'post',
         'scrollX': !0,
         ...
         "bSort": false,
         "ajax": {
            url: base_url + 'settings/get_split_type_list',
            data: function (d) {
				var split_type = $("#split_type").val();
				var statuss= '';
