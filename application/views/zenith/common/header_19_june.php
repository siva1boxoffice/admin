...
<head>
  ...
  <link href="<?php echo base_url();?>assets/zenith_assets/libs/bootstrap-touchspin/css/jquery.bootstrap-touchspin.css" rel="stylesheet" type="text/css" />
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/zenith_assets/css/styles.css?v=1.4.39191194" />
    <!-- ================== BEGIN APP CSS  ================== -->
   ...
   <div class="left-bar">
      <div class="navbar-brand-box">
         ...
         <a href="<?php echo base_url(); ?>home/index" class="logo logo-light">
            <span class="logo-sm"><img src="<?php echo base_url(); ?>assets/zenith_assets/img/logo.png" alt="Lettstart Admin"></span>
                                            ...
                                            foreach($module_arr as $md_key=>$md_value)
                                            {
                                                ...
                                                <li class="side-nav-item">
                                                    ...
                                                    <ul aria-expanded="false" class="nav-third-level">
                                                        ...
                                                        {?>
                                                            <li>
                                                                <a class="side-nav-link" href="<?php echo $md_value[$sub_key]['url']; ?>"> <?php echo ucwords(strtolower($md_value[$sub_key]['name'])); ?> </a>
                                                            </li>
                                                        <?php }
                                                        ?>
                                                    </ul>
