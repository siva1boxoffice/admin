<?php 
if (isset($this->session) && !empty($this->session->userdata('profile_pic'))) {
    // profile_pic is set and not empty
    // display the user's profile picture
} else {
    // profile_pic is not set or empty
...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url(); ?>assets/zenith_assets/img/favicon.ico"
        type="image/x-icon" />
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/zenith_assets/libs/owl-carousel/css/owl.carousel.min.css?v=1.3.9" />
    ...
    <link href="<?php echo base_url();?>assets/zenith_assets/libs/datatables/css/responsive.bootstrap4.min.css?v=1.3.4" rel="stylesheet" />
    <link href="<?php echo base_url();?>assets/zenith_assets/libs/datatables/css/buttons.bootstrap4.min.css?v=1.3.2" rel="stylesheet" />
    <link href="<?php echo base_url();?>assets/zenith_assets/libs/datatables/css/select.bootstrap4.min.css?v=1.4.6" rel="stylesheet" />
    <link rel="stylesheet" href="https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/themes/smoothness/jquery-ui.css">
    <link href="<?php echo base_url();?>assets/zenith_assets/libs/datatables/css/bootstrap-table.min.css?v=2.3.4" rel="stylesheet" />
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/zenith_assets/css/bootstrap.css" />
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/zenith_assets/css/styles.css?v=1.4.39" />
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/zenith_assets/css/fonts.css" />
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/zenith_assets/css/mCustomScrollBox.css">
                    ...
                    <div class="navbar-brand-box">
                        <a href="<?php echo base_url(); ?>home/index" class="logo logo-dark">
                            <span class="logo-sm"><img
                                    src="<?php echo base_url(); ?>assets/zenith_assets/img/logo-white-sm.png"
                                    alt="Lettstart Admin"></span>
                            <span class="logo-lg"><img
                                    src="<?php echo base_url(); ?>assets/zenith_assets/img/logo-white.png"
                                    alt="Lettstart Admin"></span>
                        </a>
                        <a href="<?php echo base_url(); ?>home/index" class="logo logo-light">
                            <span class="logo-sm"><img
                                    src="<?php echo base_url(); ?>assets/zenith_assets/img/logo-sm.png"
                                    alt="Lettstart Admin"></span>
                            <span class="logo-lg"><img src="<?php echo base_url(); ?>assets/zenith_assets/img/logo.png"
                                    alt="Lettstart Admin"></span>
                        </a>
                    </div>
                ...
                <div class="right-bar">
                    ...
                    <div class="d-inline-flex ml-0 ml-sm-2 dropdown">
                        <button aria-haspopup="true" data-toggle="dropdown" type="button"
                            ...
                            <img src="<?php echo base_url();?>assets/img/icons/flags/<?php echo $this->session->userdata('language_code');?>.svg" class="mh-16" alt="">
                        ...
                        <div aria-labelledby="page-header-country-dropdown" id="countries"
                            ...
                            <a href="javascript:void(0);" class="dropdown-item" onclick="set_language('<?php echo $language->language_code;?>');">
                                <img class="mr-1 mh-12" src="<?php echo base_url();?>assets/zenith_assets/img/icons/flags/<?php echo $language->language_flag;?>" alt="<?php echo $language->language_name;?>">
                                <span class="align-middle" data-lang="<?php echo $language->language_code;?>"><?php echo $language->language_name;?></span>
                            </a>
                            <?php } ?>
                    ...
                    <div class="d-inline-flex ml-0 ml-sm-2 dropdown">
                        <button data-toggle="dropdown" aria-haspopup="true" type="button"
                            ...
                            <img src="<?php echo $this->session->userdata('profile_pic'); ?>" alt="Header Avatar"
                        ...
                        for($jd=0;$jd<count($menu_title_v);$jd++)
                        {
                            ...
                            <li>
                                <a href="javascript:void(0);" class="side-nav-link" aria-expanded="false">
                                    ...
                                    <span> <?php echo $menu_title_v[$jd]->privilege_title;?></span>
                                           ...
                                           $module_arr=[];
                                            ...
                                            foreach($module_arr as $md_key=>$md_value)
                                            {
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="javascript:void(0);" class="side-nav-link-a" aria-expanded="false"> <?php echo $md_key; ?>
                                                    ...
                                                    <ul aria-expanded="false" class="nav-third-level">
                                                        ...
                                                        {?>
                                                            <li>
                                                                <a class="side-nav-link" href="<?php echo $md_value[$sub_key]['url']; ?>"> <?php echo $md_value[$sub_key]['name']; ?> </a>
                                                            </li>
                                                        <?php }
                                                        ?>
                                                    </ul>
