      ...
      <div class="page-title-box">
         <div class="container-fluid">
            <div class="page-title dflex-between-center">
               <h3 class="mb-1">Seller Request List</h3>               
            </div>
         </div>
      </div>
      <!-- page content -->
...
<script>
   ...
   var Dtable = $('#tournament-list').DataTable({
         ...
         "bSort": false,
         "ajax": {
            url: base_url + 'home/get_seller_request',
            data: function (d) {
               var seller_name = '';
    ...
    $('.status_search').on('click', function (e) {
      ...
      $(".check_box").change(function() { 
         ...
         var checkedIds = [];
            ...
            sessionStorage.setItem('seller_request', JSON.stringify(filters));
          Dtable.draw();        
...
var storedFilters = sessionStorage.getItem('seller_request');
...
$(".check_box input[type='checkbox']").each(function() {
  ...
  var filters = JSON.parse(sessionStorage.getItem('seller_request'));
