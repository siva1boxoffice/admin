                                          ...
                                          <div id="collapseOne" class="collapse show mt-3" aria-labelledby="headingOne"
                                            data-parent="#general">
                                             ...
                                             <div class="pt-3 float-right">
                                                <a href="javascript:void(0);" class="ms-1 waves-effect waves-light" data-effect="wave" type="submit">View All</a>
                                             </div>
                                          </div>
                                        </div>
                                     </div>
                                 ...
                                 <table class="table table-borderless mb-0 table-sm">
                                    <tbody>
                                       ...
                                       <tr>
                                          ...
                                          <td>                                   
                                             <div class="signed_contract mt-4">
                                             <div class="bttns">
                           ...
                           <ul class="list-unstyled activity-widget mb-0">
                              ...
                              if(!empty($seller_private_notes))
                              {
                                 ...
                                 <div class="order_val mt-2">
                                    <div class="order_ids"><p class="mb-0">#<?php echo $private_note->booking_id; ?></p></div>
