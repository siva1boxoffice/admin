...
<?php
$admin_id=$seller_profile_info[0]->admin_id;
                     ...
                     <div class="card-body">
                        <div class="profile_details mt-3 pt-2">
                           ...
                           <span class="badge   <?php 
                            if($documents->contract_status == 2){
                              echo "badge-success";
                            }
                            else if($documents->contract_status == 1){
                              echo "badge-success";
                            }
                            else if($documents->contract_status == 3){
                              echo "badge-danger";
                            }
                            else{
                              echo "badge-danger";
                           ...
                           ?></span>
                           <?php  if($documents->contract_status == 2){?>
                            <select seller="<?php echo $documents->seller_id;?>" name="contract" class="form-control widdh_50 approve_reject"> 
                            <option value="2"  <?php  if($documents->contract_status == 2){?> checked <?php } ?>>Received</option>
                            <option value="1" <?php  if($documents->contract_status == 1){?> checked <?php } ?>>Approve</option>
                            <option value="3" <?php  if($documents->contract_status == 3){?> checked <?php } ?>>Reject</option>
                            </select>
                          <?php } ?>
                           <div>
                          ...
                          <div class="modal fade" id="centermodal_new" tabindex="-1" role="dialog" aria-hidden="true">
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                 <div class="signed_cnct">
                                     <?php 
                                     $contract_document = "";
                                     if ($documents->contract_document != "")
                                     {
                                      $contract_document = $documents->contract_document;
                                        echo "<p>".$documents->contract_document."</p>"; 
                                       // echo  '<a target="_blank" href="'.$contract_document.'" class="btn mb-4 mt-4 download_contract" download>Download</a>';
                                      ?>
                                     <a href="javascript:void(0);" class="btn mb-4 mt-4 download_contract" download-file="<?php echo $contract_document;?>">Download</a>
                                   <?php } ?>
                                     <div class="signed_upload mt-3 mb-4">
                                       <div class="form-group mb-0">
                                          <div class="input-group">
                                            <div class="custom-file">
                                              <input type="file" class="custom-file-input signed_contract_file" name="docs[]" data-index= "0" id="signed_contract_file_1" seller="<?php echo $seller_profile_info[0]->admin_id; ?>" data-name="contract">
                           ...
                           data-target="#centermodal_new">Signed Contract</button> -->
                           <span class="badge   <?php 
                            if($documents->photo_status == 2){
                              echo "badge-success";
                            }
                            else if($documents->photo_status == 1){
                              echo "badge-success";
                            }
                            else if($documents->photo_status == 3){
                              echo "badge-danger";
                            }
                            else{
                              echo "badge-danger";
                           ...
                           ?>" data-toggle="modal"
                           data-target="#user_img_upload_modal">
                            <?php 
                            if($documents->photo_status == 2){
                              echo "Received";
                            }
                           ...
                           ?></span>
                           <?php  if($documents->photo_status == 2){?>
                            <select seller="<?php echo $documents->seller_id;?>" name="photo" class="form-control widdh_50 approve_reject"> 
                            <option value="2"  <?php  if($documents->photo_status == 2){?> checked <?php } ?>>Received</option>
                            <option value="1" <?php  if($documents->photo_status == 1){?> checked <?php } ?>>Approve</option>
                            <option value="3" <?php  if($documents->photo_status == 3){?> checked <?php } ?>>Reject</option>
                            </select>
                          <?php } ?>
                           <div>
                                                <!-- Center modal content -->
                                             <div class="modal fade" id="user_img_upload_modal" tabindex="-1" role="dialog" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                   <div class="modal-content">
                                                   <div class="modal-header">
                                                      <h4 class="modal-title" id="myCenterModalLabel">Photo ID</h4>
                                                      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                   </div>
                                                   <div class="modal-body">
                                                      <div class="signed_cnct">
                                         ...
                                         {
                                          $photo_document = $documents->photo_document;
                                            echo "<p>".$documents->photo_document."</p>"; 
                                           // echo  '<a target="_blank" href="'.$contract_document.'" class="btn mb-4 mt-4 download_contract" download>Download</a>';
                                          ?>
                                         <a href="javascript:void(0);" class="btn mb-4 mt-4 download_contract" download-file="<?php echo $photo_document;?>">Download</a>
                                       <?php } ?>
                                                         <div class="signed_upload mt-3 mb-4">
                                                            <div class="form-group mb-0">
                                                               <div class="input-group">
                                                               <div class="custom-file">
                                                                  <input type="file" class="custom-file-input signed_contract_file" name="docs[]" data-index= "1" seller="<?php echo $seller_profile_info[0]->admin_id; ?>" data-name="photo" id="signed_contract_file_2">
                                                                  <label class="custom-file-label" for="inputGroupFile04">Upload New</label>
                                                               </div>
                                                               </div>
                                                            </div>
                           ...
                           data-target="#centermodal_new">Signed Contract</button> -->
                           <span class="badge   <?php 
                            if($documents->address_status == 2){
                              echo "badge-success";
                            }
                            else if($documents->address_status == 1){
                              echo "badge-success";
                            }
                            else if($documents->address_status == 3){
                              echo "badge-danger";
                            }
                            else{
                              echo "badge-danger";
                           ...
                           ?>" data-toggle="modal"
                           data-target="#user_img_upload_modal1">
                            <?php 
                            if($documents->address_status == 2){
                              echo "Received";
                            }
                           ...
                           ?></span>
                            <?php  if($documents->address_status == 2){?>
                            <select seller="<?php echo $documents->seller_id;?>" name="address" class="form-control widdh_50 approve_reject"> 
                          <option value="2"  <?php  if($documents->address_status == 2){?> checked <?php } ?>>Received</option>
                            <option value="1" <?php  if($documents->address_status == 1){?> checked <?php } ?>>Approve</option>
                            <option value="3" <?php  if($documents->address_status == 3){?> checked <?php } ?>>Reject</option>
                            </select>
                          <?php } ?>
                           <div>
                                                <!-- Center modal content -->
                                             <div class="modal fade" id="user_img_upload_modal1" tabindex="-1" role="dialog" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                   <div class="modal-content">
                                                   <div class="modal-header">
                                                      <h4 class="modal-title" id="myCenterModalLabel">Address Proof</h4>
                                                      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                   </div>
                                                   <div class="modal-body">
                                                      <div class="signed_cnct">
                                         ...
                                         {
                                          $address_document = $documents->address_document;
                                            echo "<p>".$documents->address_document."</p>"; 
                                           // echo  '<a target="_blank" href="'.$contract_document.'" class="btn mb-4 mt-4 download_contract" download>Download</a>';
                                          ?>
                                         <a href="javascript:void(0);" class="btn mb-4 mt-4 download_contract" download-file="<?php echo $address_document;?>">Download</a>
                                       <?php } ?>
                                                         <div class="signed_upload mt-3 mb-4">
                                                            <div class="form-group mb-0">
                                                               <div class="input-group">
                                                               <div class="custom-file">
                                                                  <input type="file" class="custom-file-input signed_contract_file" name="docs[]" data-index= "2" id="signed_contract_file_3" seller="<?php echo $seller_profile_info[0]->admin_id; ?>" data-name="address">
                                                                  <label class="custom-file-label" for="inputGroupFile04">Upload New</label>
                                                               </div>
                                                               </div>
                                                            </div>
...
?>
                  <div class="card rounded-0">
                     <div class="card-body">
                        ...
                        <div class="">
                           <ul class="list-unstyled activity-widget mb-0">
                              <li class="activity-list mb-3 show_currency">
                                 <button type="button" class='btn btn_currency btn-primary waves-effect waves-light rounded-0' data-toggle="modal" data-target="#centermodal" data-currency="GBP">GBP</button>
                              </li>
                              <li class="activity-list mb-3 show_currency">
                                 <button type="button" class="btn btn_currency btn-primary waves-effect waves-light rounded-0" data-toggle="modal" data-target="#centermodal" data-currency="USD">USD</button>
                              </li>
                              <li class="activity-list mb-3 show_currency">
                                 <button type="button" class='btn btn_currency btn-primary waves-effect waves-light rounded-0' data-toggle="modal" data-target="#centermodal" data-currency="EUR">EURO</button>
                              </li>
                           </ul>
                        </div>
                     </div>
                  ...
                  <div class="modal fade" id="centermodal" tabindex="-1" role="dialog" aria-hidden="true">
                     <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                              <div class="modal-header">
                                 <h4 class="modal-title" id="currency_modal_title">Account Details</h4>
                                 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                              </div>
                              <div class="modal-body">
                                 <div class="acc_details data_hide">
                                    <div class="table-responsive">
                                          <table class="table table-borderless mb-0 table-sm">
                                             <tbody>
                                                <tr>
                                          ...
                                          <div class="col-lg-12">
                                             <div class="mb-0 mt-2 float-right">
                                 ...
                                 <div class="edit_acc_details data_show" style="display: none;">
		                                    <div class="table-responsive">
                                          <form id="currency_form" method="post" class="currency_form" action="<?php echo base_url();?>home/save_user_currency_info" >
                                          <input type="hidden" name="inpt_seller_id" id="inpt_seller_id"  value=""> 
                                          <input type="hidden" name="inpt_currency" id="inpt_currency"  value=""> 
		                                          ...
		                                          <table class="table table-borderless mb-0 table-sm">
		                                             <tbody>
		                                                <tr>
		                                                   ...
		                                                   <td>
			                                                   	<div class="form-group mb-0">
			                                                       <input type="text" id="input_benef_name" name="input_benef_name" class="form-control rounded-0" placeholder="" value="" required >
			                                                   	</div>
		                                                   </td>
		                                                </tr>
		                                                <tr>
		                                                   ...
		                                                   <td>
			                                                   	<div class="form-group mb-0">
			                                                       <input type="text" id="input_bank_name" name="input_bank_name" class="form-control rounded-0" placeholder="" value="" required>
			                                                   	</div>
		                                                   </td>
		                                                </tr>
		                                                <tr>
		                                                   ...
		                                                   <td>
			                                                   	<div class="form-group mb-0">
			                                                       <input type="text" id="input_acc_no" name="input_acc_no" class="form-control rounded-0" placeholder="" value="" required>
			                                                   	</div>
		                                                   </td>
		                                                </tr>
                                                      <tr>
		                                                   ...
		                                                   <td>
			                                                   	<div class="form-group mb-0">
			                                                       <input type="text" id="input_address" name="input_address" class="form-control rounded-0" placeholder="" value="" required>
			                                                   	</div>
		                                                   </td>
		                                                </tr>
		                                                <tr>
		                                                   ...
		                                                   <td>
			                                                   	<div class="form-group mb-0">
			                                                       <input type="text" id="input_s_code" name="input_s_code" class="form-control rounded-0" placeholder="" value="" required>
			                                                   	</div>
		                                                   </td>
		                                                </tr>
		                                                <tr>
		                                                   ...
		                                                   <td>
			                                                   	<div class="form-group mb-0">
			                                                       <input type="text" id="input_iban" name="input_iban" class="form-control rounded-0" placeholder="" value="" required>
			                                                   	</div>
		                                                   </td>
		                                                </tr>
		                                          	...
		                                          	<div class="col-lg-12">
			                                           <div class="mb-0 mt-2 float-right d-flex">
			                                              <button class="save_add_btn btn btn-primary ms-1 waves-effect waves-light" data-effect="wave" type="submit">Save</button>
			                                              <div class="go_back">
				                                              <a href="javascript:void(0);" id='back_btn'>Back</a>
				                                          </div>
			                                           </div> 
			                                        </div> 
                                            </form>
...
else 
{
   ...
   $('.show_currency button').click(function () {  
      $(".data_hide").show();
     $(".data_show").hide();   
      ...
      if (errorLabel) {
         errorLabel.style.display = "none"; // Hide the error message
      }
      input.value = ""; // Clear the input value
            ...
            data: { "id":user_id,"currency": currency },
            dataType: 'json',
            success: function (data) {
                  $('#currency_modal_title').text(currency + ' Account Details');
                  ...
                  $('#inpt_currency').val(currency);
                  $('#inpt_seller_id').val(user_id);
                  
                  
                  $('#input_benef_name').val(data.beneficiaryName);
                  $('#input_bank_name').val(data.bankName);
                  $('#input_acc_no').val(data.accountNumber);
                  $('#input_s_code').val(data.swiftCode);
                  $('#input_iban').val(data.iban);
   ...
   if(buttonText=="EURO")
      ...
      var file = $(this).attr("download-file");
      var fileUrl = '<?php echo UPLOAD_PATH.'uploads/seller_documents/';?>'+file;
      downloadFile(fileUrl);
      });

      $('.download_admin_profile_pic').click(function() {
      var fileUrl = '<?php echo UPLOAD_PATH.'uploads/users/'.basename($seller_profile_info[0]->admin_profile_pic);?>';
      downloadFile(fileUrl);
      });
 ...
 /*  $('.download_contract').click(function() {  
  ...
  $('.download_admin_profile_pic').click(function() {  
    ...
    var file_data = $('#'+index).prop('files')[0];
    ...
    var document_type = $(this).attr('data-name');   
  ...
  form_data.append('document_type', document_type);
    ...
    $.ajax({
	  url: '<?php echo base_url();?>home/update_seller_documents_single',
      type: 'POST',
	  async: false,
	  cache: false,
	  contentType: false,
  ...
  $('.admin_profile_file').on('change', function() {
    ...
    var allowed_types = ['image/jpeg','image/JPEG','image/PNG', 'image/png','image/GIF','image/gif','application/pdf'];
    if (allowed_types.indexOf(file_data.type) === -1) {
      swal('Error!', "File type not allowed. Please select a JPEG,PNG,or PDF file.", 'error');
      return;
    }
   ...
   var form_data = new FormData();
    ...
    var document_type = $(this).attr('name');   
    var seller_id     = $(this).attr('seller'); 
...
$(document).on('change', '.approve_reject', function() {
    ...
    // AJAX request
    $.ajax({
        url: base_url + 'home/update_seller_documents',
        method: "POST",
        data: { "document_type": document_type ,"seller_id": seller_id,"status" : status},
        dataType: 'json',
        success: function(result) {
            if (result) {
                $('.close').trigger('click');
