      ...
      <div class="page-title-box">
         <div class="container-fluid">
            <div class="page-title dflex-between-center">
               <h3 class="mb-1">Tournament Sales Summary</h3>
            </div>
         </div>
      </div>
      <!-- page content -->
         ...
         <div class="container-fluid">
                              ...
                              <?php if (count($getMySalesData_usd) > 0) { ?>
                                ...
                                <!--  <p class="mt-2 mb-1 no_orders font-12">No of Orders
                                    <span class="font-weight-normal mt-0 mb-0 font-10 color_main ml-3"><i
                                       ...
                                       <?php echo number_format(count($getMySalesData_usd),2); ?>
                                    </span>
                                 </p> -->
                              <?php } else {
                     ...
                     <div class="card-body">
                        <div class="media align-items-center">
                           <div class="media-body currency_status">
                              ...
                              <?php if (true) { ?>
                                 <h4 class="mb-0 font-weight-bold"><span class="font-weight-bold mr-1"><?php echo count($getMySalesData_usd); ?></span>
                                    <?php //echo $total_base_amount = number_format(array_sum(array_column($getMySalesData_total, 'total_base_amount')),2); ?>
                                 </h4>
                                 <!-- <p class="mt-2 mb-1 no_orders font-12">No of Orders
                                    <span class="font-weight-normal mt-0 mb-0 font-10 color_main ml-3"><i
                                          class="bx bx-up-arrow-alt"></i>+
               ...
               <div class="col-md-6 col-xl-3">
                  <div class="card rounded-0">
                     <div class="card-body">
                        <div class="media align-items-center">
                           <div class="media-body currency_status">
                              <p class="mb-2 font-weight-normal color_main">Total Tickets Sold</p>
                              <?php if (true) { ?>
                                 <h4 class="mb-0 font-weight-bold"><span class="font-weight-bold mr-1"><?php echo $total_base_amount =array_sum(array_column($getMySalesData_usd,'total_quantity'));?></span>
                                    <?php //echo $total_base_amount = number_format(array_sum(array_column($getMySalesData_total, 'total_base_amount')),2); ?>
                                 </h4>
                                 <!-- <p class="mt-2 mb-1 no_orders font-12">No of Orders
                                    <span class="font-weight-normal mt-0 mb-0 font-10 color_main ml-3"><i
                                          class="bx bx-up-arrow-alt"></i>+
                                       <?php// echo number_format(count($getMySalesData_total),2); ?>
                                    </span>
                                 </p> -->
                              <?php } else {
                                 echo '<h3>No Tickets Sold.</h3>';
                              } ?>
                           </div>
                           <!-- <div class="text-center currency_symb pounds">
                              <span class="pounds font-weight-normal">£</span>
               ...
               <div class="col-md-6 col-xl-3">
                  <div class="card rounded-0">
                     <div class="card-body">
                        <div class="media align-items-center">
                           <div class="media-body currency_status">
                              <p class="mb-2 font-weight-normal color_main">Total Ticket Pending</p>
                              <?php if (true) { ?>
                                 <h4 class="mb-0 font-weight-bold"><span class="font-weight-bold mr-1"> <?php echo $all_total_ticket ;?></span>
                                    <?php //echo $total_base_amount = number_format(array_sum(array_column($getMySalesData_total, 'total_base_amount')),2); ?>
                                 </h4>
                                 <!-- <p class="mt-2 mb-1 no_orders font-12">No of Orders
                                    <span class="font-weight-normal mt-0 mb-0 font-10 color_main ml-3"><i
            ...
            <div class="card">
               <div class="card-body">
                                       ...
                                       <div class="btn-group">
                                          <div class="dropdown">
                                             <button class="btn btn-light dropdown-toggle date_search_filter" type="button"
                                                ...
                                                aria-expanded="false">
                                                Match Date <i class="mdi mdi-chevron-down"></i>
                                             </button>
                  ...
                  <div class="">
                     <table style='width:100% !important' id="tournament-sales-datatable"
                        class="table table-hover table-nowrap mb-0 sales-summary-class">
                        <thead class="thead-light">
                           <tr>
                              <th>Tournamen Name</th>
                              <th>Match Name</th>
                              <th>Ticket Listed</th>
                              <th>Ticket Sold</th>
                              <th>Remaining </th>
...
<script>
   $(document).ready(function () {
    ...
    //  $('.order_status').on('click', function () {
      ...
      var overlay = $('#overlay');
      var Dtable = $('#tournament-sales-datatable').DataTable({
         'info': false,
         //'processing': true,
         'scrollX': !0,
         'serverSide': true,
         ...
         "pageLength" : 50,
         "ajax": {
            url: base_url + 'accounts/get_tournament_sales_summary',
            data: function (d) {
    ...
    complete: function() {
      ...
      $('.clear_all').click(function () {
         ...
         $('.tournament_search_filter').text("Ticket Category");
