      ...
      <div class="page-title-box">
         <div class="container-fluid">
            <div class="page-title dflex-between-center">
               <h3 class="mb-1">Partner Sales Summary</h3>
            </div>
         </div>
      </div>
      <!-- page content -->
         ...
         <div class="container-fluid">
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="">
                     <table style='width:100% !important' id="partner-sales-summary-datatable"
...
<script>
   $(document).ready(function () {
    ...
    //  $('.order_status').on('click', function () {
      ...
      var overlay = $('#overlay');
      var Dtable = $('#partner-sales-summary-datatable').DataTable({
         'info': false,
         //'processing': true,
         'scrollX': !0,
         'serverSide': true,
         ...
         "pageLength" : 50,
         "ajax": {
            url: base_url + 'accounts/get_partner_sales_summary',
            data: function (d) {
