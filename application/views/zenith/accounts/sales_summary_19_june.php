      ...
      <div class="page-title-box">
         <div class="container-fluid">
            <div class="page-title dflex-between-center">
               <h3 class="mb-1">Sales Summary</h3>
            </div>
         </div>
      </div>
      <!-- page content -->
                        ...
                        <div class="media align-items-center">
                           <div class="media-body currency_status">
                              ...
                              <h4 class="mb-0 font-weight-bold"><span class="font-weight-bold mr-1">£</span>
                                 ...
                                 if ($cnt > 0) {
                                    echo $total_base_amount = array_sum(array_column($getMySalesData_gbp, 'total_amount'));
                                    ?>
                                 </h4>
                        ...
                        <div class="media align-items-center">
                           <div class="media-body currency_status">
                              ...
                              <?php if (count($getMySalesData_eur) > 0) { ?>
                                 <h4 class="mb-0 font-weight-bold"><span class="font-weight-bold mr-1">€</span>
                                    <?php echo $total_base_amount = array_sum(array_column($getMySalesData_eur, 'total_amount')); ?>
                                 </h4>
                                 <p class="mt-2 mb-1 no_orders font-12">No of Orders
                                    <span class="font-weight-normal mt-0 mb-0 font-10 color_main ml-3"><i
                                          class="bx bx-up-arrow-alt"></i>+
                        ...
                        <div class="media align-items-center">
                           <div class="media-body currency_status">
                              ...
                              <?php if (count($getMySalesData_usd) > 0) { ?>
                                 <h4 class="mb-0 font-weight-bold"><span class="font-weight-bold mr-1">$</span>
                                    <?php echo $total_base_amount = array_sum(array_column($getMySalesData_usd, 'total_amount')); ?>
                                 </h4>
                                 <p class="mt-2 mb-1 no_orders font-12">No of Orders
                                    <span class="font-weight-normal mt-0 mb-0 font-10 color_main ml-3"><i
                                          class="bx bx-up-arrow-alt"></i>+
                        ...
                        <div class="media align-items-center">
                           <div class="media-body currency_status">
                              ...
                              <?php if (count($getMySalesData_total) > 0) { ?>
                                 <h4 class="mb-0 font-weight-bold"><span class="font-weight-bold mr-1">£</span>
                                    <?php echo $total_base_amount = array_sum(array_column($getMySalesData_total, 'total_base_amount')); ?>
                                 </h4>
                                 <p class="mt-2 mb-1 no_orders font-12">No of Orders
                                    <span class="font-weight-normal mt-0 mb-0 font-10 color_main ml-3"><i
                                          class="bx bx-up-arrow-alt"></i>+
                                       <?php echo count($getMySalesData_total); ?>
                                    </span>
                                 </p>
                              <?php } else {
                                 echo '<h3>No Orders.</h3>';
               ...
               <div class="card-body">
                              ...
                              <div class="sort_filters">
                                 <ul>
                                             ...
                                             <div class="dropdown-menu dropdown-menu-custom"
                                                ...
                                                <div class="reset_btn">
                                                   <div class="reset_txt"><button
                                                         class="btn btn-info clear_all">Reset</button></div>
                                    ...
                                    <li class="sort_list">
                                       <div class="btn-group">
                                          <div class="dropdown">
                                             <button class="btn btn-light dropdown-toggle ticket_category_btn"
                                                ...
                                                <div id="view_project_list_wrapper"
                                                   ...
                                                   <div id="view_project_list_filter" class="dataTables_filter"><label
                                                         class="search-box d-inline-flex position-relative">Search:<input
                                                            ...
                                                            id="ticket_category"></label></div>
                                                </div>
                                                <div class="seat_category_check_box">


                                                   <?php
                                                   echo $this->mydatas['seat_category'];
                                                   ?>
                                                </div>
                                                <div class="reset_btn">
                                                   <div class="reset_txt"><button
                                                         class="btn btn-info category_reset">Reset</button></div>
                                                   <div class="reset_ok"><button
                                                         class="btn btn-info ticket_ctgry">Search</button></div>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                  ...
                  <div class="table-responsive">
                     <table style='width:100% !important' id="sales-datatable"
                        class="table table-responsive table-hover table-nowrap mb-0">
                        ...
                        <tbody>
                           <!-- <tr>
                                    ...
                                    <td>2</td>                                
                                    <td>Sat 14 Dec 2023<br>11:34</td>
                                    <td>Sat 14 Dec 2023<br>11:34</td>
                                    <td>£ 10,750.00</td>
                                    <td style="text-align: center;">
                                       <div class="">
...
<script>
   $(document).ready(function () {
    ...
    //  $('.order_status').on('click', function () {
      ...
      // $('.dropdown-menu-custom .seat_category_check_box').click(function(e){
      //        //  alert('dd');
      //     e.stopPropagation();
      // });
      ...
      var overlay = $('#overlay');
      var Dtable = $('#sales-datatable').DataTable({
         'info': false,
         //'processing': true,
         'serverSide': true,
         'serverMethod': 'post',
         "pageLength" : 50,
         "ajax": {
            url: base_url + 'accounts/get_items',
            data: function (d) {
      ...
      overlay.hide();
        ...
        //    loadingRecords: '&nbsp;',
         ...
         'columns': [
            ...
            //          return  '<a class="tooltip_texts" data-toggle="tooltip" data-placement="right" title="" data-original-title="Meet Up with Seller" aria-describedby="tooltip173041"><i class="fas fa-comment-dots"></i></a>'
            //      }
            //      },
            { data: 'qty' },
