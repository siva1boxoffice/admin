      ...
      <div class="page-title-box">
         <div class="container-fluid">
            <!-- <div class="page-title dflex-between-center">
               <h3 class="mb-1">Match Categories</h3>
            </div> -->
            <div class="page-title dflex-between-center">
               <h3 class="mb-1">Match Categories</h3>
               <div class="float-sm-right mt-3 mt-sm-0 add_team_s">
                  <a href="<?php echo base_url(); ?>game/category/add_category"  class="btn btn-success mb-2">Add Match Categories</a>
               </div>
             </div>
         </div>
      </div>
         ...
         <div class="container-fluid">
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="">
                     <table style='width:100% !important' id="match-category-list" class="table table-hover table-nowrap mb-0 tournament">
...
<script>
    ...
    var overlay = $('#overlay');
   var Dtable = $('#match-category-list').DataTable({
         'info': false,
         'serverSide': true,
         'serverMethod': 'post',
         'scrollX': !0,
         ...
         "bSort": false,
         "ajax": {
            url: base_url + 'game/get_match_category_list',
            data: function (d) {
