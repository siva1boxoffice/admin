											...
											?>
													<tr>
														...
														<td class="padd_50" data-label="Booked On:">
															...
															<!-- <?php echo date("d-F-Y h:i:s",strtotime($getMySalesDa->updated_at));
                                                            ?> -->
												...
												?>
												<?= number_format($getMySalesDa->premium_price,2) ?> 
												 </b></td>
												 <?php }?>
												 <?php  if ($this->session->userdata('role') == 1) { ?>	
														<td data-label="Price:"><b>		
												...
												<?= number_format($getMySalesDa->ticket_amount,2) ?> 
												 ...
												 <?php }?>
														...
														<td data-label="View Details:"><a href="<?php echo base_url(); ?>game/orders/details/<?php echo md5($getMySalesDa->booking_no); ?>"> <img style="width: 30px;" class="arrow_click" src="<?php echo base_url();?>assets/img/icons/arrow-right-circle.svg?v=1"><button class="btn_mobile">Click Here</button></a></td>
													</tr>
											<?php
												}
											}else{ ?>
