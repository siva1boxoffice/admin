                                      ...
                                      <div class="row column_modified">
                                          <div class="col-lg-3">
                                             <div class="form-group">
                                                 ...
                                                 <select class="actionpayout roleuser custom-select" required name="parent_category" id="parent_category">
                                          ...
                                          <div class="col-lg-3">
                                             <div class="form-group">
                                                 ...
                                                 <select class="actionpayout roleuser custom-select"  name="category" id="category">
                                          ...
                                          <div class="col-lg-3">
                                             <div class="form-group">
                                                 <label for="example-select">Select Tournament Category <span class="text-danger">*</span></label>
                                                 <select class="actionpayout roleuser custom-select"  name="tournament" id="tournament">
                                            <option value="">Choose Tournament Category</option>
                                          ...
                                          <div class="col-lg-3">
                                             <div class="form-group">
                                                 ...
                                                 <select class="actionpayout roleuser custom-select"  name="tournaments" id="tournaments">
