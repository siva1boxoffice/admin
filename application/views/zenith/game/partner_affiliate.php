      ...
      <div class="page-title-box">
         <div class="container-fluid">
            <div class="page-title dflex-between-center">
               <h3 class="mb-1"> Partner / Affiliate Orders</h3>
            </div>
         </div>
      </div>
      <!-- page content -->
                              ...
                              <div class="sort_filters">
                                 ...
                                 <li class="sort_list">
                                    ...
                                    <li class="sort_list">
                                            ...
                                            <div class="btn-group">
                                                <div class="dropdown">
                                                    <button class="btn btn-light dropdown-toggle partner_affiliate_btn" type="button" id="dropdownMenuButton"
                                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                     Partner / Affiliate<i class="mdi mdi-chevron-down"></i>
                                                    </button>
                                                    <div class="dropdown-menu dropdown-menu-custom" aria-labelledby="dropdownMenuButton">
                                                        <div id="view_project_list_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                                        <div id="view_project_list_filter" class="dataTables_filter"><label class="search-box d-inline-flex position-relative">Search:<input type="search" class="form-control form-control-sm" placeholder="Search in Filters..." aria-controls="view_project_list" id="partner_affiliate_status" autocomplete="off" ></label></div>
                                                    </div>
                                                    <div class="partner_affiliate_check_box">
                                                        
                                                        <?php 
                                                            echo $this->data['data_aff_check'];
                                                        ?>
                                                        </div>
                                                        <div class="reset_btn">
                                                         <div class="reset_txt"><button class="btn btn-info partner_affiliate_reset " >Reset</button></div>
                                                         <div class="reset_ok"><button class="btn btn-info partner_affiliate_search">Search</button></div>
                                                      </div>
                                                    </div>
                                                </div>
                                            </div>
...
$(".seat_category_check_box").change(function() { 
         ...
         "ajax": {
            ...
            data: function (d) {
              ...
              // var shipping_status = $('#shipping-status-hidden').data('shipping-status-hidden');
               ...
               var partnerAffiliateId = [];
               $(".partner_affiliate_check_box input:checked").each(function() {
                  var newID = $(this).attr('value');  
                  partnerAffiliateId.push(newID);
               });
               ...
               d.partner_affiliateid = partnerAffiliateId;
            },
            beforeSend: function () {
      ...
      $('.partner_affiliate_search').on('click', function (e) {  
         $('.partner_affiliate_btn').addClass("filter_active");  
    ...
    $("#partner_affiliate_status").keyup(function() { 
            var searchText = $(this).val();
            if(searchText.length > 0 ){
               var newsearchText =  searchText.toLowerCase();
                  $( '.partner_affiliate_check_box .custom-checkbox' ).hide();
                  $( ".partner_affiliate_check_box .custom-checkbox[data-category^=" + newsearchText + "]").show();
            }
            else{
               $( '.partner_affiliate_check_box .custom-checkbox' ).show();
            }


    });

     $(".partner_affiliate_reset").click(function() { 
           $(".partner_affiliate_status").prop('checked', false);

    });


     $(".partner_affiliate_status").change(function(e) { 
         e.stopPropagation();
         $('.partner_affiliate_btn').addClass("filter_active");
         if($(".partner_affiliate_status:checked").length >  0){
            var show_txt = $(".partner_affiliate_status:checked").length + " Selected" ;
         }  
         else{
            var show_txt = "Partner / Affiliate";
            $('.partner_affiliate_btn').removeClass("filter_active");
         }
         $('.partner_affiliate_btn').html(show_txt);
     });

    
      $("body").on('click','.partner_affiliate_check_box',function(e){
    //    alert('dd');
    e.stopPropagation();
});
