                  ...
                  <div class="row align-items-center">
                     <div class="col-sm-4 col-xl-4">
                        <div class="page-title">
                           <h3 class="mb-1 font-weight-bold">Blog Category</h3>
                        </div>
                     </div>
                     <div class="col-sm-8 col-xl-8 text-sm-right mt-2 mt-sm-0">
                        <div class="float-sm-right mt-3 mt-sm-0 team_lists_bttn">
                        
                           <a href="<?php echo base_url();?>blog/category/add/"  class="btn btn-success mb-2 ">Add Category</a>
                        </div>
                     </div>
                  </div>
               </div>
                                  ...
                                  <li class="sort_list">
                                             <div class="btn-group">
                                                <div class="dropdown">
                                                   ...
                                                   <span class="text_class">Category Name</span>  <span class="selected_class"></span> <i class="mdi mdi-chevron-down"></i>
                                                   </button>
                                                   <div class="dropdown-menu dropdown-menu-custom" aria-labelledby="dropdownMenuButton">
                                                      <div id="view_project_list_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                                      <div id="view_project_list_filter" class="dataTables_filter"><label class="search-box d-inline-flex position-relative">Search:<input type="search" id="category_name" name="category_name" class="form-control form-control-sm category_name" placeholder="Search in Filters..." aria-controls="view_project_list"></label></div>
                                                   </div>
                                                      <div class="reset_btn">
       ...
       var Dtable =  $('#view_project_list').DataTable(
{
        ...
        "ordering": false,
         ...
         //  'info': false,
          'ajax': {
             'url':'<?php echo base_url('blog/category_ajax') ;?>',
              data: function (d) {
    ...
    complete: function() {
      ...
      overlay.hide();
       ...
       $('.event_search_ok').on('click', function (e) {
         ...
         var event_name_filter_len = $("#category_name").val();
