                  ...
                  <div class="row align-items-center">
                     <div class="col-sm-4 col-xl-4">
                        <div class="page-title">
                           <h3 class="mb-1 font-weight-bold">Blog Tags</h3>
                        </div>
                     </div>
                     <div class="col-sm-8 col-xl-8 text-sm-right mt-2 mt-sm-0">
                        <div class="float-sm-right mt-3 mt-sm-0 team_lists_bttn">
                        
                           <a href="<?php echo base_url();?>blog/blog_tags/add/"  class="btn btn-success mb-2 ">Add Blog Tags</a>
                        </div>
                     </div>
                  </div>
               </div>
                        ...
                        <div class="row">
                                ...
                                <input type="hidden" class="flag" name="flag" id="flag" value="<?php echo $this->uri->segment(3);?>">
                                 ...
                                 <ul>
                                  <li class="sort_list">
                                             <div class="btn-group">
                                                <div class="dropdown">
                                                   ...
                                                   <span class="text_class">Blog Tag (EN)</span>  <span class="selected_class"></span> <i class="mdi mdi-chevron-down"></i>
                                                   </button>
                                  ...
                                  <li class="sort_list">
                                             <div class="btn-group">
                                                <div class="dropdown">
                                                   <button class="btn btn-light dropdown-toggle blog_tag_ar_filter" type="button" id="dropdownMenuButton"
                                                   data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                   <span class="text_class">Blog Tag (AR)</span>  <span class="selected_class"></span> <i class="mdi mdi-chevron-down"></i>
                                                   </button>
                                                   <div class="dropdown-menu dropdown-menu-custom" aria-labelledby="dropdownMenuButton">
                                                      <div id="view_project_list_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                                      <div id="view_project_list_filter" class="dataTables_filter"><label class="search-box d-inline-flex position-relative">Search:<input type="search" id="blog_name_ar" name="blog_name_ar" class="form-control form-control-sm blog_name" placeholder="Search in Filters..." aria-controls="view_project_list"></label></div>
                                                   </div>
                                                      <div class="reset_btn">
                                                         <div class="reset_txt"><button class="btn btn-info match_id_rest">Reset</button></div>
                                                         <div class="reset_ok"><button class="btn btn-info blog_name_ar">Search</button></div>
                                                      </div>
                                                   </div>
                                                </div>
                                             </div>
                           ...
                           <table style="width: 100% !important;" class="table  table-hover table-nowrap mb-0 events_new-1" id="view_project_list">
                              ...
                              <thead class="thead-light">
                                 <tr>
                                    <th class="before_none">Blog Tags (EN)</th>
                                    <th class="before_none">Blog Tags (AR)</th>
                                    <!-- <th class="before_none"></th> -->
       ...
       var Dtable =  $('#view_project_list').DataTable(
{
        ...
        "ordering": false,
         ...
         //  'info': false,
          'ajax': {
             'url':'<?php echo base_url('blog/blog_tags_ajax') ;?>',
              data: function (d) {
                var blog_name = $("#blog_name").val();
                var blog_name_ar = $("#blog_name_ar").val();
             //   var stadium = $(".stadium").val();
                ...
                d.blog_tag_en = blog_name;
                d.blog_tag_ar = blog_name_ar;
    ...
    complete: function() {
      ...
      overlay.hide();
          ...
          'columns': [
             { data: 'blog_tag_name_en' },
             { data: 'blog_tag_name_ar' },
             { data: 'status' },
             { data: 'action' },
          ]
        });
       ...
       $("body").on("click",".match_id_rest",function(){
         ...
         $('.blog_tag_ar_filter').removeClass("filter_active");
       // alert("rest");
      ...
      $('.blog_name_ar').on('click', function (e) {
         var event_name_filter_len = $("#blog_name_ar").val();
         if(event_name_filter_len.length > 0) {
         	$('.blog_tag_ar_filter').addClass("filter_active");
         }
         else{
         	$('.blog_tag_ar_filter').removeClass("filter_active");
         }
