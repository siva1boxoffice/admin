            ...
            <div class="clone-listing-table-div">
              <table class="table  table-borderless clone-listing-table">
                  ...
                  <tr id="clone-listing-table-tr" class="tbl_row">
                    ...
                    <td>
                     <select name="ticket_category[]" data-ticket="<?php echo $list_ticket->ticketid; ?>" id="ticket-category-<?php echo $list_ticket->ticketid; ?>" data-match="<?php echo $list_ticket->match_id; ?>" class="ticket_category form-control custom-select" cat="<?php echo $list_ticket->ticket_category;?>">
                    ...
                    <td>
                     <select name="ticket_block[]" data-ticket="<?php echo $list_ticket->ticketid; ?>" id="ticket-block-<?php echo $list_ticket->ticketid; ?>" class="ticket_block form-control custom-select">
...
<a href="javascript:void(0)" class="td_close" style="display: none;"><i class="fas fa-times-circle"></i></a></td>
                  </tr>
              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                 ...
                 <!--    <button id="clone_submit" class="btn clone-listing-save-btn fs-16" disabled> Save</button> -->
                     <button id="clone_submit" data-url="save_mass_duplicate_<?php echo $list_ticket->ticketid; ?>" type="button" class="btn clone-listing-save-btn fs-16 save_mass_duplicates_details" disabled="true"  data-match="<?php echo $list_ticket->match_id; ?>">Save</button>
