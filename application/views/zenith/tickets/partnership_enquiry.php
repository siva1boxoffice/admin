      ...
      <div class="page-title-box">
         <div class="container-fluid">
            <div class="page-title dflex-between-center">
               <h3 class="mb-1">Partner Enquiry List</h3>
            </div>
         </div>
      </div>
      <!-- page content -->
      <div class="page-content-wrapper mt--45 all_orders_page">
         <div class="container-fluid">
            ...
            <div class="card">
               <div class="card-body">
                  <div class="">
                     <table style='width:100% !important' id="partner-enquiry-list" class="table table-hover table-nowrap mb-0 tournament">
...
<script>
    ...
    var overlay = $('#overlay');
   var Dtable = $('#partner-enquiry-list').DataTable({
         'info': false,
         'serverSide': true,
         'serverMethod': 'post',
         'scrollX': !0,
         ...
         "bSort": false,
         "ajax": {
            url: base_url + 'tickets/get_partner_enquiry_list',
            data: function (d) {
