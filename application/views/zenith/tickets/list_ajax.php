                                                ...
                                                <tr>
                                                   ...
                                                   <td>
                                                      <div class="custom-control custom-switch">
                                                         <input type="checkbox"  data-ticket="<?php echo $ticket->ticketid; ?>"  class="custom-control-input sell_ticket_status" id="customSwitch<?php echo $i;?>" name="status" <?php if ($ticket->status == 1) { ?> checked="checked" <?php } ?> value="1" >
