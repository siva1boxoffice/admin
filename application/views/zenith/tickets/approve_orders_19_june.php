                                             ...
                                             <div class="btn-group">
                                                <div class="dropdown">
                                                   ...
                                                   <div class="seat_category_check_box">
                                                      ...
                                                      <div class="reset_btn">
                                                         <div class="reset_txt"><button class="btn btn-info category_reset clear_all" >Reset</button></div>
...
<script type="text/javascript">
  ...
  complete: function() {
    ...
    overlay.hide();
    bind_record='<div class="float-left pagination-detail"><div class="approve_all_select"><button type="button" class="btn btn-info waves-effect waves-light" data-effect="wave" id="approve_all_order"><a class="button is-success" href="javascript:void(0);">Approve All Selected</a> </button> </div></div>';
