   ...
   <div class="columns">
      ...
      <div class="column is-8">
         <div class="account-box is-form is-footerless">
            <form id="profile-form" method="post" class="validate_form_v2 form_req_validation login-wrapper" action="<?php echo base_url();?>home/users/save_user">
                  ...
                  <div class="fieldset">
                     ...
                     <div class="columns is-multiline">
                        ...
                        <div class="column is-12">
                           <div class="field">
                              <div class="control has-icon">
                                 <input type="text" name="company_name" class="input" placeholder="Company Name." value="<?php echo $user->company_name;?>">
                                 <div class="form-icon">
                        ...
                        <div class="column is-12">
                           <div class="field">
                              <div class="control has-icon">
                                 <input type="text" name="company_url" class="input" placeholder="Company Url." value="<?php echo $user->company_url;?>">
                                 <div class="form-icon">
                        ...
                        <div class="column is-12" id="show_other_event" style="display:none;">
                           <div class="field">
                              <div class="control">
