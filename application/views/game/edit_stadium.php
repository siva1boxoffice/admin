            ...
            <div class="mapsvg-dashboard" id="mapsvg-admin">
                    ...
                    <div class="stretch mapsvg-panel-right">
                        ...
                        <ul class="nav nav-tabs" id="myTab">
                          ...
                          <!--   <li><a href="#tab_colors">Colors</a></li> -->
                            <li><a href="#tab_regions">Edit map</a></li>
                            <li><a href="#tab_color_group">Group Colors</a></li>
                        </ul>
                ...
                <script type="text/x-handlebars-template" id="mapsvg-control-panel">
                    ...
                    <input class="form-control" type="text" autocomplete="off" disabled="true" value="{{svgFilename}}"/>
 					...
 					<div class="form-group">
                    <label class="col-sm-3 control-label">Stadium name english</label>
                    <div class="col-sm-9">
                    ...
                    <div class="form-group">
                    <label class="col-sm-3 control-label">Stadium name arabic</label>
                    <div class="col-sm-9">
                    ...
                    ?>" data-live="keyup" />
                     ...
                     <div class="form-group">
                    <label class="col-sm-3 control-label">Seach Keyword</label>
                    <div class="col-sm-9">
                    ...
                    <p>Use Comma Separated Key.For Ex.Lord stadium,london..</p>
                      ...
                      <div class="form-group">
                    <label class="col-sm-3 control-label">Stadium variant</label>
                    <div class="col-sm-9">
                    ...
                    <div class="form-group" id="mapsvg-global-popovers" style="display:none;">
                    ...
                    <div class="form-group" id="mapsvg-global-tooltips" style="display:none;">
                    ...
                    <div class="tab-pane " id="tab_color_group">
                            ...
                            <div class="form-group form-group-color">
                                <label class="col-sm-3 control-label">Color

                                 </label>
                                 <div class="col-sm-2">
                                    <div style="background:<?php echo  $c->block_color ;?>; padding:20px;     width: 50px;"></div></div>
                                <div class="col-sm-7">
                                 ...
                                 <div class="col-sm-7" style="margin-top:20px">
                                    ...
                                    <select class="form-control stadium_category_by_color " name="<?php echo $c->block_color ;?>"  >
