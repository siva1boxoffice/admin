...
<div id="app-onboarding" class="view-wrapper is-webapp" data-page-title="Order List" data-naver-offset="214" data-menu-item="#layouts-navbar-menu" data-mobile-item="#home-sidebar-menu-mobile">
 ...
 -->
							...
							<div class="list_button order_inf">
								<a href="<?php echo base_url();?>game/orders/partner_order/all" class="user_buts <?php if($this->uri->segment(4) == 'all' || $this->uri->segment(4) == '' ){?> active <?php } ?>">All</a>
							<a href="<?php echo base_url();?>game/orders/partner_order/confirmed" class="user_buts <?php if($this->uri->segment(4) == 'confirmed'){?> active <?php } ?>">Confirmed</a>
							<a href="<?php echo base_url();?>game/orders/partner_order/pending" class="user_buts <?php if($this->uri->segment(4) == 'pending'){?> active <?php } ?>">Pending</a>
													...
													<tr>
														...
														<td class="padd_50" data-label="Booked On:">
															<span class="tr_date"><i class="fas fa-calendar"></i>
																<?php
																echo date("d F Y H:i:s",strtotime(time_zone_calc(@$_COOKIE["client_time_zone"],$getMySalesDa->created_at))).' '.@$_COOKIE["time_zone"];
																
															?></span> <br><span class="tr_date"><i class="fas fa-clock"></i><?php echo date('h:i',strtotime($getMySalesDa->created_at)); ?></span>
														</td>
														...
														<?php } ?>											</td>
															...
															<td data-label="Buyer Name:">
															<?php echo $getMySalesDa->partner_first_name;
															?> <?php echo $getMySalesDa->partner_last_name;
															?>
															</td>
											...
											<?php } ?>
												...
												<?= number_format($getMySalesDa->ticket_amount,2) ?> 
												 ...
												 <?php }?>
														...
														<td data-label="View Details:"><a href="<?php echo base_url(); ?>game/orders/details/<?php echo md5($getMySalesDa->booking_no); ?>"> <img class="arrow_click" src="<?php echo base_url();?>assets/img/icons/arrow-right-circle.svg?v=1"><button class="btn_mobile">Click Here</button></a></td>
													</tr>
											<?php
												}
											}else{ ?>
		...
		<div class="right-panel-body has-slimscroll">
			<div class="languages-boxes">
				<div class="form-fieldset">
					...
					<form id="filter-forms" method="post" class="login-wrapper" action="<?php echo base_url(); ?>game/orders/partner_order">
...
<script type="text/javascript">
	function load_my_orders(seller_id) {
		window.location.href = "<?php echo base_url();?>game/orders/partner_order/all/"+seller_id;
	}
</script>
<?php exit; ?>
