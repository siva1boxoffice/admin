	...
	<div class="page-content-wrapper">
		<div class="page-content is-relative tabs-wrapper is-slider is-squared is-inverted">
			<div class="list-flex-toolbar is-reversed flex-list-v2">
				<a class="button is-circle is-primary" href="<?php echo base_url(); ?>game/stadium_category/add">
				...
				<div class="flex-list-wrapper flex-list-v2">
					<div class="flex-table">
						...
						<div class="flex-table-header" data-filter-hide>
							...
							<span class="is-grow">arabic</span>
						...
						<div class="flex-list-inner">
							...
							foreach ($categories as $category) {
								...
								$stadium_seat_id = $category->id;
								$stadium_arabic = $CI->General_Model->getAllItemTable_array('stadium_seats_lang', array('stadium_seat_id' => $stadium_seat_id,'language' => 'ar'))->row();

								//echo "<pre>";print_r($stadium_arabic);
							?>
								<!--Table item-->
								<div class="flex-table-item">
									...
									<div class="flex-table-cell is-media is-grow">
										<div>
											<span class="item-name dark-inverted" data-filter-match><?php echo $stadium_arabic->seat_category; ?></span>
										</div>
									</div>
									<div class="flex-table-cell is-media is-grow">
										<div>
										...
										<div class="dropdown is-spaced is-dots is-right dropdown-trigger is-pushed-mobile">
											...
											<div class="dropdown-menu" role="menu">
												<div class="dropdown-content">
													<a href="<?php echo base_url(); ?>game/stadium_category/edit/<?php echo $category->id; ?>" class="dropdown-item is-media">
														<div class="icon">
													...
													<a id="branch_<?php echo $category->id; ?>" href="javascript:void(0);" data-href="<?php echo base_url(); ?>game/stadium_category/delete/<?php echo $category->id; ?>" class="dropdown-item is-media delete_action" onClick="delete_data('<?php echo $category->id; ?>');">
														<div class="icon">
