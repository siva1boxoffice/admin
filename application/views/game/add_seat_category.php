        				...
        				<div class="flex-list-wrapper">
        					...
        					<div class="form-layout">
        						<div class="form-outer">
        							<form id="category-form" method="post" class=" login-wrapper form_req_validation" action="<?php echo base_url(); ?>game/seat_category/save">
        								...
        								<div class="form-header stuck-header">
        									<div class="form-header-inner">
        										<?php if (!empty($category_details)) { ?>
        											<div class="left">
        												<h3>Edit Seat Category</h3>
        											</div>
        										<?php	} else { ?>
        											<div class="left">
        												<h3>Create New Seat Category</h3>
        											</div>
        										<?php } ?>
        										<div class="right">
        											<div class="buttons">
        													...
        													<div class="control has-icon">
        														<div class="switch-block no-padding-all">
        															<label class="form-switch is-primary">
        																<input type="checkbox" class="is-switch" id="is_active" name="is_active" value="1" <?php if (isset($category_details->status)) {
																																								if ($category_details->status == '1') { ?> checked <?php }
																																																			} ?>>
        																<i></i>
        															</label>
        															<div class="text">
