                        ...
                        <div class="row">
                           ...
                           <div class="col-lg-5">
                              <div class="orders_team_name">
                                ...
                                <p><span class="no_of_ticket"><i class="mdi mdi-ticket-confirmation-outline"></i> <?php echo $category_details['no_ticket'];?> Tickets</span> <span class="ticket_trans"><img src="<?php echo $category_details['ticket_type_image'] ;?>" width="18px"<?php echo $category_details['ticket_type_name'];?>> <?php echo $category_details['ticket_type_name'];?> </span></p>
                     ...
                     // branch-form-btn
                      ...
                      $.ajax({
                        ...
                        //    alert('Booking Success');
                           ...
                           //  alert('Failed')
                             swal('Updation Failed !', "Booking Failed", 'error');
                           // setTimeout(window.location.reload(),300);
                             window.location.href = data.redirect_url;
