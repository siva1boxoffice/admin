<?php $this->load->view('common/header');?>
      ...
      <div class="page-content is-relative business-dashboard course-dashboard">
                     ...
                     <div class="page-content-inner">
                         <form id="branch-form" method="post" class="validate_form_v1 login-wrapper" action="<?php echo base_url();?>api/api_partner_markup/save_markup">
                            ...
                            <div class="form-outer">
                                <div class="form-header stuck-header">
                                    <div class="form-header-inner">
                                        <div class="left">
                                            <h3>Create New Partner Markup</h3>
                                        </div>
                                        <div class="right">
                                            <div class="buttons">
                                                <a href="<?php echo base_url();?>api/api_partner_markup/partner_matkup_list" class="button h-button is-light is-dark-outlined">
                                                    <span class="icon">
