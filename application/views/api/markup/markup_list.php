                    ...
                    <div class="dashboard-title is-main">
                        ...
                        <div class="right">
                            <div class="list-flex-toolbar is-reversed ">
                                <a class="button is-circle is-primary" href="<?php echo base_url();?>api/api_partner_markup/add_partner_markup">
                                         ...
                                         <div class="flex-table-cell cell-end" data-th="Actions">
                                            <div class="dropdown is-spaced is-dots is-right dropdown-trigger is-pushed-mobile">
                                                ...
                                                <div class="dropdown-menu" role="menu">
                                                    ...
                                                    <?php if($role == 1){ ?>
                                                        <a href="<?php echo base_url();?>api/api_partner_markup/add_partner_markup/<?php echo base64_encode(json_encode($markup->id));?>" class="dropdown-item is-media">
                                                            <div class="icon">
