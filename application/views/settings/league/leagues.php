        	...
        	<div class="page-content-wrapper">
        		<div class="page-content is-relative business-dashboard course-dashboard">
        			<div class="list-flex-toolbar is-reversed ">
        				<a title="Add Top League" class="button is-circle is-primary" href="<?php echo base_url(); ?>settings/league/add" class="button h-button is-primary is-elevated">
        				...
        				<div class="control has-icon">
        					<form method='post' action="<?= base_url() ?>/settings/league">
        				...
        				<div class="">
        					<div class="dashboard-title is-main">
        						<div class="">
        							<h2 class="dark-inverted">Top League Lists</h2>
        						</div>
        					</div>
        				</div>
        			</div>
								...
								?>
        							<div class="flex-table-item">
        								<div class="flex-table-cell is-bold" data-th="country">
        									<span class="dark-text" data-filter-match><?php echo $topleague->tournament_name; ?></span>
        								</div>
        									...
        									<div class="dropdown is-spaced is-dots is-right dropdown-trigger is-pushed-mobile">
        										...
        										<div class="dropdown-menu" role="menu">
        											<div class="dropdown-content">
        												<a href="<?php echo base_url(); ?>settings/league/edit/<?php echo $topleague->id; ?>" class="dropdown-item is-media">
        													<div class="icon">
        												...
        												<a id="branch_<?php echo $topleague->id; ?>" href="javascript:void(0);" data-href="<?php echo base_url(); ?>settings/league/delete/<?php echo $topleague->id; ?>" class="dropdown-item is-media delete_action" onClick="delete_data('<?php echo $topleague->id; ?>');">
        													<div class="icon">
