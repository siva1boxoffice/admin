        							...
        							<form id="top-league-form" method="post" class="validate_form_v1 login-wrapper validate_form_v1" action="<?php echo base_url(); ?>settings/cups/save">
        								...
        								<div class="form-header stuck-header">
        									<div class="form-header-inner">
        										<div class="left">
        											<h3>Add New Top Cup</h3>
        										</div>
        										<div class="right">
        											<div class="buttons">
        												<a href="<?php echo base_url(); ?>settings/cups" class="button h-button is-light is-dark-outlined">
        													<span class="icon">
        													...
        													<div class="control has-icon">
        														<select class="form-control select2" id="tournament" name="tournament" required>
        															...
        															<?php foreach ($tournments as $tournment) { ?>
        																<option value="<?php echo $tournment->t_id; ?>" <?php if (isset($top_cup->tournament_id)) {
