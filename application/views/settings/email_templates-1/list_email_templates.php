                    ...
                    <div class="page-content-inner">
                        ...
                        <div class="flex-list-wrapper">
                                ...
                                <div class="flex-table">
                                    ...
                                    <span class="is-grow">&nbsp;From Email Id</span>
                                    <span class="is-grow">&nbsp;&nbsp;To Email Id</span>
                                    ...
                                    <div class="flex-list-inner">
                                        ...
                                        <div class="flex-table-item">
                                            <div class="flex-table-cell is-media is-grow">
                                                ...
                                                <div>
                                                    <span class="item-name dark-inverted" data-filter-match><?php echo $email->email_type;?></span>
                                                </div>
                                            </div>
                                            <div class="flex-table-cell is-media is-grow">
                                               
                                                <div>
                                                    <span class="light-text" data-filter-match><?php echo $email->from_emailid;?></span>
                                                </div>
                                            </div>
                                              ...
                                              <div class="flex-table-cell is-media is-grow">
                                                ...
                                                <div>
                                                    <span class="light-text" data-filter-match><?php echo $email->to_emailid;?></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex-table-cell is-grow" data-th="Industry">
                                                <span class="light-text" data-filter-match><?= $email->subject; ?></span>
                                            </div>
