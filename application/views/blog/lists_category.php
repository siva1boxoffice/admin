						...
						<div class="page-content-wrapper">
			        		  <div class="page-content is-relative business-dashboard course-dashboard">
			        			<div class="list-flex-toolbar is-reversed flex-list-v2">
			        				<a class="button is-circle is-primary" href="<?php echo base_url();?>/blog/category/add">
									...
									<table class="toptable res_table_new table-responsive">
										<tbody>
											...
											<tr>
												...
												<td><?php echo $row->category_status == 1? '<span class="tag is-success is-rounded">Active</span>'  : '<span class="tag is-danger is-rounded">Inactive</span>';?></td>
                                            ...
                                            <div class="dropdown is-spaced is-dots is-right dropdown-trigger is-pushed-mobile">
                                                ...
                                                <div class="dropdown-menu" role="menu">
                                                    <div class="dropdown-content">
                                                        <a href="<?php echo base_url();?>blog/category/edit/<?php echo $row->id ;?>" class="dropdown-item is-media">
                                                        ...
                                                        <a  href="<?php echo base_url();?>blog/category/delete/<?php echo $row->id ;?>" class="dropdown-item is-media " >
                                                            <div class="icon">
