...
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/assets_ticket/css/app.css?v=1.2" />
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/assets_ticket/css/main.css?v=1.3" />
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/assets_ticket/css/style.css?v=3.9" />
<div id="app-apex-charts" class="view-wrapper is-webapp" data-page-title="Add Details" data-naver-offset="150" data-menu-item="#dashboards-navbar-menu" data-mobile-item="#home-sidebar-menu-mobile">
   <div class="page-content-wrapper">
      <div class="page-content is-relative">
         <form id="create_ticket" action="<?php echo base_url(); ?>tickets/create_ticket" class="name validate_form_v3" method="post">
                        ...
                        <div class="column is-8">
                                 ...
                                 <a class="project-grid-item">
                                    <div class="radio-toolbar">
                                       <label for="radio_ticket_<?php echo $ticket_key; ?><?php echo $ticket_key; ?>">
                                          <input type="radio" id="radio_ticket_<?php echo $ticket_key; ?><?php echo $ticket_key; ?>" name="ticket_types[]" value="<?php echo $ticket_type->id; ?>" data-error="#errNm1">
                           ...
                           <div class="number_ticket list_ticket_type">
                              ...
                              <div class="column is-2">
                                 <a href="javascript:void(0);" onclick="getticketQty(1);">
                                    <div class="radio-toolbar1">
                                       <input required="" type="radio" id="getticketQty_1" name="add_qty_addlist[]" value="1" data-error="#errNm2">
                                       <label for="radioOne" style="cursor: pointer;">1</label>
                                    </div>
                                 </a>
                              </div>
                              <div class="column is-2">
                              ...
                              <div class="column is-2">
                                 <a href="javascript:void(0);" onclick="getticketQty(1);">
                                    <div class="radio-toolbar1">
                                       <input required="" type="radio" id="getticketQty_1" name="add_qty_addlist[]" value="1" data-error="#errNm2">
                                       <label for="radioOne" style="cursor: pointer;">6</label>
                                    </div>
                                 </a>
                              </div>
                              <div class="column is-2">
                                 <a href="javascript:void(0);" onclick="getticketQty(1);">
                                    <div class="radio-toolbar1">
                                       <input required="" type="radio" id="getticketQty_1" name="add_qty_addlist[]" value="1" data-error="#errNm2">
                                       <label for="radioOne" style="cursor: pointer;">7</label>
                                    </div>
                                 </a>
                              </div>
                              <div class="column is-2">
                                 <a href="javascript:void(0);" onclick="getticketQty(1);">
                                    <div class="radio-toolbar1">
                                       <input required="" type="radio" id="getticketQty_1" name="add_qty_addlist[]" value="1" data-error="#errNm2">
                                       <label for="radioOne" style="cursor: pointer;">8</label>
                                    </div>
                                 </a>
                              </div>
                              <div class="column is-2">
                                 <a href="javascript:void(0);" onclick="getticketQty(1);">
                                    <div class="radio-toolbar1">
                                       <input required="" type="radio" id="getticketQty_1" name="add_qty_addlist[]" value="1" data-error="#errNm2">
                                       <label for="radioOne" style="cursor: pointer;">9</label>
                                    </div>
                                 </a>
                              </div>
                              <div class="column is-2">
                           ...
                           <div class="price list_ticket_type">
                              ...
                              <div class="columns is-multiline is-flex-tablet-p">
                              <div class="column is-3">
                                 <div class="details fontuser">
                                    <label for="row">Price</label>
                                    <input type="text" name="add_price_addlist[]" id="add_price_addlist" placeholder="0.00" required data-error="#errNm4">
                              ...
                              <div class="column is-3">
                                 <div class="select details">
                                    ...
                                    <select class="form-control" id="add_pricetype_addlist" name="add_pricetype_addlist[]" required data-error="#errNm4">
                                    </select>
                                 </div>
                              </div>
                              <div class="column">
                           ...
                           <div class="clearfix"></div>
                           <div class="seat_detail list_ticket_type">
                              <h2>Seat Details</h2>
                           ...
                           <div class="clearfix"></div>
                           <div class="ticket_details list_ticket_type">
                                    ...
                                    <ul class="select_detail_chk">
                                       <?php
                                          ...
                                          foreach ($ticket_details as $ticket_detail) { 
                                          	...
                                          	?>
                                       <li class="">
                                          <img src="<?php echo base_url().'uploads/ticket_details/'.$ticket_detail->ticket_image;?>" width="24px" height="24px">
                                          <h5 for="vehicle1"><?php echo $ticket_detail->ticket_det_name; ?></h5>
                                          <label class="select_ticket_type">
                              ...
                              <div class="content">
                                 <div class="select_resti ">
                                    <div class="event_info">
                                          ...
                                          <div class="selec_img">
                                             <img src="https://phpstack-775220-2636850.cloudwaysapps.com/Template_design_new/assets/img/flag.png">
                                         </div>
                                    </div>
...
<script>
  $(document).ready(function() {
    ...
    $('body').on("click","label",function() {
      //alert();
        // $('list_ticket_type').removeClass('yellowBackground');
         $(this).parents(".select_ticket_type").find(".yellowBackground").removeClass();
        $(this).addClass('yellowBackground');
