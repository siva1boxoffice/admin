   ...
   <table class="toptable res_table_new table-responsive">
      <tbody>
         ...
         <?php foreach ($listings as $list_ticket) {
            ...
            if($tickets){             $min_price = min(array_column($tickets, 'price'));
         ...
         <tr style="cursor: pointer;" >
            ...
            <td class="ticket_list_row" flag-id="ticket_td_<?php echo $list_ticket->m_id; ?>" data-label="Event:"> <?php echo $teams[0]; ?> <span class="vs">vs</span><br><?php echo $teams[1]; ?></td>
            <td class="ticket_list_row class_mob" flag-id="ticket_td_<?php echo $list_ticket->m_id; ?>" data-label="Tournament:"><?php echo $list_ticket->tournament_name; ?></td>
                       ...
                       <!--  <td colspan="2" data-label="Selling type">
                        ...
                        <td colspan="12">
                                    ...
                                    <div class="modal-card">
                                       ...
                                       <section class="modal-card-body">
                                          ...
                                          <div class="mass_duplicate_heading">
                                            <h2> <?php echo $teams[0]; ?> <span class="vs">vs</span> <?php echo $teams[1]; ?> - <?php echo $list_ticket->tournament_name; ?></h2>
                                       ...
                                       <p><?php echo $list_ticket->stadium_name; ?>,<?php echo $list_ticket->city_name; ?>,<?php echo $list_ticket->country_name; ?></p>
                                        ...
                                        <div class="modal-card-foot is-centered">
                                             <a class="button notes_cancel h-button is-rounded h-modal-close">Cancel</a>
                                             <button data-url="save_mass_duplicate_<?php echo $ticket->ticketid; ?>" type="button" class="button h-button is-primary is-raised is-rounded save_mass_duplicates">Save</button>
                                          </div>
                                       </form>
                                    </div>
                                 </div>
                           ...
                           <?php } ?>
                               ...
                               <a href="javascript:void(0);" data-modal="duplicates" data-match="<?php echo $ticket->match_id; ?>" data-s_no="<?php echo $ticket->s_no; ?>" data-ticket="<?php echo $ticket->ticketid; ?>" id="duplicates" class="mass_duplicate is-solid hint--top h-modal-trigger" data-hint="Mass Duplicate Ticket">
