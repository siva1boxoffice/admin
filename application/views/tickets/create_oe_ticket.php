                     ...
                     <div class="search_btn">
                        ...
                        <div class="centDivsearch ">
                           <select required name="add_eventname_addlist[]" id="add_event_name" class="input sell_select" data-error="#errNm0">
                              ...
                              <option value="<?php echo $matche->m_id; ?>"><?php echo $matche->match_name; ?> - <?php echo $matche->match_date_format; ?> - <?php echo $matche->category_name; ?></option>
                              <?php } ?>
                           </select>
                           <input type="hidden" name="event_flag" value="OE">
 ...
 -->
                               <div class="field details">
                                    <p class="control has-icons-left">
                                        ...
                                        <span class="icon is-small is-left" id="Currency_span">
                                           £
                                 ...
                                 <div class="select_resti ">
                                    <div class="event_info">
                                          ...
                                          <div class="selec_img" id="selec_img" style="display:none;">
                                             <img id="event_image" src="" style="width:60px;">
...
<script type="text/javascript">
   ...
   $(this).val("");
      ...
      $(document).on('click', "#searchmatch", function() {
         ...
         $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>tickets/getOEMatchDetails',
            data: {
               'match_id': $("#add_event_name").val()
            },
            dataType: "json",
            ...
            success: function(data) {
               ...
               if (data) {
                  $.each(data, function(index, item) {
                     ...
                     else if(item.currency_code == "GPB"){
                        $('#Currency_span').text('£');
                     }
