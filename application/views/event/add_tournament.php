                        ...
                        <div class="column is-6">
                         ...
                         <div class="column is-6">
                           <div class="field">
                              ...
                              <div class="control">
                                 <input required type="text" id="search_keywords" name="search_keywords" class="input" placeholder="Enter URL Key" value="<?php if (isset($tournaments->search_keywords)) { echo $tournaments->search_keywords; } ?>">
                              </div>
                           </div>
                        </div>
                        <div class="column is-6">
