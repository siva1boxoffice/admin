...
<?php if($matches->match_status == '1'){?> checked <?php } ?>>
                                                                    ...
                                                                    <div class="text">
                                                                        <span>Enable / disable Match Status</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                </div>
                                                    ...
                                                    <label>Upcoming Events *</label>
                                                     <div class="control has-icon">
                                                                <div class="switch-block no-padding-all">
                                                                    ...
                                                                    <div class="text">
                                                                        <span>Enable / disable Upcoming Events</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                </div>
                                                    ...
                                                    <label>Availability *</label>
                                                     <div class="control has-icon">
                                                                <div class="switch-block no-padding-all">
                                                                    ...
                                                                    <div class="text">
                                                                        <span>Request / Available Availability</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                </div>
                                                    ...
                                                    <label>Ignore auto24off *</label>
                                                     <div class="control has-icon">
                                                                <div class="switch-block no-padding-all">
                                                                    ...
                                                                    <div class="text">
                                                                        <span>Enable / disable Ignore auto24off</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                </div>
                                                    ...
                                                    <label>Top Game *</label>
                                                     <div class="control has-icon">
                                                                <div class="switch-block no-padding-all">
                                                                    ...
                                                                    <div class="text">
                                                                        <span>Enable / disable Top Game</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                </div>
                                                    ...
                                                    <label>High Demand Ticket ? *</label>
                                                     <div class="control has-icon">
                                                                <div class="switch-block no-padding-all">
                                                                    ...
                                                                    <div class="text">
                                                                        <span>Enable / disable High Demand</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                </div>
                                                    ...
                                                    <label>Almost Sold Ticket ? *</label>
                                                     <div class="control has-icon">
                                                                <div class="switch-block no-padding-all">
                                                                    ...
                                                                    <div class="text">
                                                                        <span>Enable / disable Almost Sold</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                </div>
                                                    ...
                                                    <label>Feature  Game ? *</label>
                                                     <div class="control has-icon">
                                                                <div class="switch-block no-padding-all">
                                                                    ...
                                                                    <div class="text">
                                                                        <span>Enable / disable Feature Games</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                </div>
