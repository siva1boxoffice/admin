...
$(document).on('click', ".ticket_save_details", function(e) {
...
var ticket_status   = $("#ticket_status_details_"+ticket).is(":checked");
...
$(document).on('change', ".ticket_status_details", function(e) { 
    e.stopImmediatePropagation();
   var ticket_status   = $(this).is(":checked");
   var ticket_id=$(this).attr("data-s_no");  
   var flag = $(this).attr("data-flag");
   var match_id        = $(this).attr("data-match");   
...
$(document).on('change', ".all_ticket_status_detail", function(e) {
    e.stopImmediatePropagation();
   var ticket_status   = $(this).is(":checked");
   var flag = $(this).attr("data-flag");
   var match_id        = $(this).attr("data-match");   
...
$(document).on('click', ".save_mass_duplicates_details", function(e) { 
    e.stopImmediatePropagation();
...
console.log('dfsd');
//$('#list_body').DataTable().ajax.reload();
...
var search_flag     = $("#search_flag").val();
 ...
 if (confirm("Are you sure to Delete Ticket?") == true) {
...
$(document).on('click', ".ticket_delete_detail", function() { 
    ...
    //                 }
                    ...
                    swal({
                        title: 'Are you sure to Delete Ticket?',
                        text: "Yes or No",
                        type: 'warning',
