						...
						if(full_block_data){
							...
							if(sn_exst>0){
								...
								$("." + selectCategory).each(function (i) {
									$(this).hide().delay(i * 100).fadeIn(100).siblings(".seat_select_items").hide();
								});*/
