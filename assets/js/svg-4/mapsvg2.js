...
//                        window.location.href = region.href;
            ...
            showTooltip: function (region) {
                ...
                if (tip && tip.length) {
					...
					var mtch_id=$("#main_matcheventid").val();
                    ...
                    /*$.ajax({
                        type: "POST",
                        url: base_url + '/admin/game/getSellerDetailsBydata2',
                        data: {blockid: tip, match_id: mtch_id, cat_id: $("#"+tip).data("cat")},
...
//                            console.log(response);
                            ...
                            if (getJsonArray != '') {
                                ...
                                if (status == 'OK') {
                                    _data.tooltip.container.html("Block "+ object['ticket_block'] + '<br/> ' + org_ticket + ' tickets from ' + convertCurrency(org_price)+"<br><strong>"+category+":</strong><br> Total tickets "+total_category_tickets+" from "+convertCurrency(total_category_price_from));
                                }
                            } else {
