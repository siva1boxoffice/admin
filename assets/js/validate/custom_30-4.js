...
$('.validate_form_v3').validate({
    ...
    messages: {
        "ticket_types[]": "Ticket Type is Required.Please Choose Ticket Type.",
        "add_qty_addlist[]": "Ticket Quantity is Required.Please Choose Ticket Quantity.",
        "split_type[]": "Split Type is Required.Please Choose Split Type.",
        "add_price_addlist[]": "Ticket Price is Required.",
        "ticket_category[]": "Ticket Category is Required.Please Choose Ticket Category.",
        "home_town": "Home/Down is Required.Please Choose.",
        "ticket_details[]": "Ticket Details is Required.Please Choose Ticket Details.",
        "add_pricetype_addlist[]" : "Ticket Currency is Required.Please Choose Ticket Currency.",
         "add_eventname_addlist[]": "Match Event is Required.Please Choose Any Match Event."
    },
  submitHandler: function(form) {
