...
(function ($) {
    ...
    function Region(jQueryObject, globalOptions, regionID, mapsvg) {
        ...
        //                     $(this).css({fill: mapcode.colors.base});
        //                 });
        //             }
        //             $.each(mapcode.regions, function (key, value) {
        //                 $(".mapsvg-region").each(function () {
        //                     $('#' + key).css({fill: value.fill});
        //                 });
        //             });
        //         }, 2000);
        //     }
...
//                    console.log(base_url + '/admin');
                    ...
                    // $.ajax({
                    //     type: "POST",
                    //     url: base_url + '/game/getStadiumDetailsByBlockid',
                    //     data: {'blockid': tip, 'stadiumid': stadiumId},
                    //     success: function (response)
                    //     {
                    //         var jsonObject = $.parseJSON(response);
                    //         var status = jsonObject['Status'];
                    ...
                    //             var noTickets = object['no_tickets'];
                    //             if (status == 'OK') {
                    //                 _data.tooltip.container.html(category);
                    //                 // + '<br/> ' + noTickets + ' tickets from Rs.' + price
                    //             }
                    //         } else {
                    //             _data.tooltip.container.html('no available...');
                    //         }
                    //     }
                    // });
